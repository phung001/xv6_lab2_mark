...
main(int argc, char *argv[])
{
 ...
 119:	c7 44 24 04 58 0e 00 	movl   $0xe58,0x4(%esp)
 120:	00 
 ...
 19e:	c7 44 24 04 78 0e 00 	movl   $0xe78,0x4(%esp)
 1a5:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ee:	0f b6 80 d8 0e 00 00 	movzbl 0xed8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 84c:	75 27                	jne    875 <printf+0x120>
          s = "(null)";
 84e:	c7 45 e4 8e 0e 00 00 	movl   $0xe8e,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 91b:	a1 08 0f 00 00       	mov    0xf08,%eax
...
free(void *ap)
{
 ...
 9dc:	a3 08 0f 00 00       	mov    %eax,0xf08
}
 9e1:	c9                   	leave  
 9e2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a4d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 a50:	a1 08 0f 00 00       	mov    0xf08,%eax
 a55:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a58:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a5c:	75 23                	jne    a81 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a5e:	c7 45 f0 00 0f 00 00 	movl   $0xf00,-0x10(%ebp)
 a65:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a68:	a3 08 0f 00 00       	mov    %eax,0xf08
 a6d:	a1 08 0f 00 00       	mov    0xf08,%eax
 a72:	a3 00 0f 00 00       	mov    %eax,0xf00
    base.s.size = 0;
 a77:	c7 05 04 0f 00 00 00 	movl   $0x0,0xf04
 a7e:	00 00 00 
  }
 ...
 ad4:	a3 08 0f 00 00       	mov    %eax,0xf08
      return (void*)(p + 1);
 ...
 adf:	eb 38                	jmp    b19 <malloc+0xde>
    ...
    if(p == freep)
 ae1:	a1 08 0f 00 00       	mov    0xf08,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 bc0:	c7 44 24 04 95 0e 00 	movl   $0xe95,0x4(%esp)
 bc7:	00 
 ...
 c05:	c7 44 24 04 a3 0e 00 	movl   $0xea3,0x4(%esp)
 c0c:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 d7b:	e8 cc fe ff ff       	call   c4c <init_q>
	lock_init(&s->lock);
 d80:	8b 45 08             	mov    0x8(%ebp),%eax
 d83:	83 c0 10             	add    $0x10,%eax
 d86:	89 04 24             	mov    %eax,(%esp)
 d89:	e8 a8 fd ff ff       	call   b36 <lock_init>
}
 d8e:	c9                   	leave  
 d8f:	c3                   	ret    

00000d90 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 dbd:	83 c0 10             	add    $0x10,%eax
 dc0:	89 04 24             	mov    %eax,(%esp)
 dc3:	e8 9b fd ff ff       	call   b63 <lock_release>
			break;
 dc8:	90                   	nop
 ...
 dcb:	c7 44 24 04 c1 0e 00 	movl   $0xec1,0x4(%esp)
 dd2:	00 
 dd3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 dda:	e8 76 f9 ff ff       	call   755 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 ddf:	e8 50 f8 ff ff       	call   634 <getpid>
 de4:	8b 55 08             	mov    0x8(%ebp),%edx
 de7:	83 c2 04             	add    $0x4,%edx
 dea:	89 44 24 04          	mov    %eax,0x4(%esp)
 dee:	89 14 24             	mov    %edx,(%esp)
 df1:	e8 78 fe ff ff       	call   c6e <add_q>
			//printf(1, "asleep \n");
			tsleep();
 df6:	e8 69 f8 ff ff       	call   664 <tsleep>
		}
	}
 dfb:	eb 99                	jmp    d96 <sem_acquire+0x6>
