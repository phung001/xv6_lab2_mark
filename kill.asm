...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 6a 0b 00 	movl   $0xb6a,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	0f b6 80 c8 0b 00 00 	movzbl 0xbc8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 560:	75 27                	jne    589 <printf+0x120>
          s = "(null)";
 562:	c7 45 e4 7e 0b 00 00 	movl   $0xb7e,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62f:	a1 e4 0b 00 00       	mov    0xbe4,%eax
...
free(void *ap)
{
 ...
 6f0:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 6f5:	c9                   	leave  
 6f6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 743:	e8 d8 fe ff ff       	call   620 <free>
  return freep;
 748:	a1 e4 0b 00 00       	mov    0xbe4,%eax
}
 74d:	c9                   	leave  
 74e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 761:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 764:	a1 e4 0b 00 00       	mov    0xbe4,%eax
 769:	89 45 f0             	mov    %eax,-0x10(%ebp)
 76c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 770:	75 23                	jne    795 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 772:	c7 45 f0 dc 0b 00 00 	movl   $0xbdc,-0x10(%ebp)
 779:	8b 45 f0             	mov    -0x10(%ebp),%eax
 77c:	a3 e4 0b 00 00       	mov    %eax,0xbe4
 781:	a1 e4 0b 00 00       	mov    0xbe4,%eax
 786:	a3 dc 0b 00 00       	mov    %eax,0xbdc
    base.s.size = 0;
 78b:	c7 05 e0 0b 00 00 00 	movl   $0x0,0xbe0
 792:	00 00 00 
  }
 ...
 7e8:	a3 e4 0b 00 00       	mov    %eax,0xbe4
      return (void*)(p + 1);
 ...
 7f3:	eb 38                	jmp    82d <malloc+0xde>
    ...
    if(p == freep)
 7f5:	a1 e4 0b 00 00       	mov    0xbe4,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8d4:	c7 44 24 04 85 0b 00 	movl   $0xb85,0x4(%esp)
 8db:	00 
 ...
 919:	c7 44 24 04 93 0b 00 	movl   $0xb93,0x4(%esp)
 920:	00 
 ...
 945:	c7 44 24 04 a0 0b 00 	movl   $0xba0,0x4(%esp)
 94c:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 a89:	83 c0 04             	add    $0x4,%eax
 a8c:	89 04 24             	mov    %eax,(%esp)
 a8f:	e8 cc fe ff ff       	call   960 <init_q>
	lock_init(&s->lock);
 a94:	8b 45 08             	mov    0x8(%ebp),%eax
 a97:	83 c0 10             	add    $0x10,%eax
 a9a:	89 04 24             	mov    %eax,(%esp)
 a9d:	e8 a8 fd ff ff       	call   84a <lock_init>
}
 aa2:	c9                   	leave  
 aa3:	c3                   	ret    

00000aa4 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 ad1:	83 c0 10             	add    $0x10,%eax
 ad4:	89 04 24             	mov    %eax,(%esp)
 ad7:	e8 9b fd ff ff       	call   877 <lock_release>
			break;
 adc:	90                   	nop
 ...
 adf:	c7 44 24 04 b1 0b 00 	movl   $0xbb1,0x4(%esp)
 ae6:	00 
 ae7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 aee:	e8 76 f9 ff ff       	call   469 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 af3:	e8 50 f8 ff ff       	call   348 <getpid>
 af8:	8b 55 08             	mov    0x8(%ebp),%edx
 afb:	83 c2 04             	add    $0x4,%edx
 afe:	89 44 24 04          	mov    %eax,0x4(%esp)
 b02:	89 14 24             	mov    %edx,(%esp)
 b05:	e8 78 fe ff ff       	call   982 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 b0a:	e8 69 f8 ff ff       	call   378 <tsleep>
		}
	}
 b0f:	eb 99                	jmp    aaa <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 b5b:	e8 9c fe ff ff       	call   9fc <pop_q>
 b60:	89 04 24             	mov    %eax,(%esp)
 b63:	e8 18 f8 ff ff       	call   380 <twakeup>
	}
}
 b68:	c9                   	leave  
 b69:	c3                   	ret    
