...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	0f b6 80 74 0b 00 00 	movzbl 0xb74(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 520:	75 27                	jne    549 <printf+0x120>
          s = "(null)";
 522:	c7 45 e4 2a 0b 00 00 	movl   $0xb2a,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5ef:	a1 90 0b 00 00       	mov    0xb90,%eax
...
free(void *ap)
{
 ...
 6b0:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 6b5:	c9                   	leave  
 6b6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 703:	e8 d8 fe ff ff       	call   5e0 <free>
  return freep;
 708:	a1 90 0b 00 00       	mov    0xb90,%eax
}
 70d:	c9                   	leave  
 70e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 721:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 724:	a1 90 0b 00 00       	mov    0xb90,%eax
 729:	89 45 f0             	mov    %eax,-0x10(%ebp)
 72c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 730:	75 23                	jne    755 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 732:	c7 45 f0 88 0b 00 00 	movl   $0xb88,-0x10(%ebp)
 739:	8b 45 f0             	mov    -0x10(%ebp),%eax
 73c:	a3 90 0b 00 00       	mov    %eax,0xb90
 741:	a1 90 0b 00 00       	mov    0xb90,%eax
 746:	a3 88 0b 00 00       	mov    %eax,0xb88
    base.s.size = 0;
 74b:	c7 05 8c 0b 00 00 00 	movl   $0x0,0xb8c
 752:	00 00 00 
  }
 ...
 7a8:	a3 90 0b 00 00       	mov    %eax,0xb90
      return (void*)(p + 1);
 ...
 7b3:	eb 38                	jmp    7ed <malloc+0xde>
    ...
    if(p == freep)
 7b5:	a1 90 0b 00 00       	mov    0xb90,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 894:	c7 44 24 04 31 0b 00 	movl   $0xb31,0x4(%esp)
 89b:	00 
 ...
 8d9:	c7 44 24 04 3f 0b 00 	movl   $0xb3f,0x4(%esp)
 8e0:	00 
 ...
 905:	c7 44 24 04 4c 0b 00 	movl   $0xb4c,0x4(%esp)
 90c:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 a49:	83 c0 04             	add    $0x4,%eax
 a4c:	89 04 24             	mov    %eax,(%esp)
 a4f:	e8 cc fe ff ff       	call   920 <init_q>
	lock_init(&s->lock);
 a54:	8b 45 08             	mov    0x8(%ebp),%eax
 a57:	83 c0 10             	add    $0x10,%eax
 a5a:	89 04 24             	mov    %eax,(%esp)
 a5d:	e8 a8 fd ff ff       	call   80a <lock_init>
}
 a62:	c9                   	leave  
 a63:	c3                   	ret    

00000a64 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 a91:	83 c0 10             	add    $0x10,%eax
 a94:	89 04 24             	mov    %eax,(%esp)
 a97:	e8 9b fd ff ff       	call   837 <lock_release>
			break;
 a9c:	90                   	nop
 ...
 a9f:	c7 44 24 04 5d 0b 00 	movl   $0xb5d,0x4(%esp)
 aa6:	00 
 aa7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 aae:	e8 76 f9 ff ff       	call   429 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 ab3:	e8 50 f8 ff ff       	call   308 <getpid>
 ab8:	8b 55 08             	mov    0x8(%ebp),%edx
 abb:	83 c2 04             	add    $0x4,%edx
 abe:	89 44 24 04          	mov    %eax,0x4(%esp)
 ac2:	89 14 24             	mov    %edx,(%esp)
 ac5:	e8 78 fe ff ff       	call   942 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 aca:	e8 69 f8 ff ff       	call   338 <tsleep>
		}
	}
 acf:	eb 99                	jmp    a6a <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 b1b:	e8 9c fe ff ff       	call   9bc <pop_q>
 b20:	89 04 24             	mov    %eax,(%esp)
 b23:	e8 18 f8 ff ff       	call   340 <twakeup>
	}
}
 b28:	c9                   	leave  
 b29:	c3                   	ret    
