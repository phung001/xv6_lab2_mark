...
fmtname(char *path)
{
  ...
  5f:	c7 04 24 04 0f 00 00 	movl   $0xf04,(%esp)
  ...
  8a:	05 04 0f 00 00       	add    $0xf04,%eax
  ...
  return buf;
  a3:	b8 04 0f 00 00       	mov    $0xf04,%eax
}
...
ls(char *path)
{
  ...
  dd:	c7 44 24 04 5a 0e 00 	movl   $0xe5a,0x4(%esp)
  e4:	00 
 ...
 116:	c7 44 24 04 6e 0e 00 	movl   $0xe6e,0x4(%esp)
 11d:	00 
 ...
 181:	c7 44 24 04 82 0e 00 	movl   $0xe82,0x4(%esp)
 188:	00 
 ...
 1af:	c7 44 24 04 8f 0e 00 	movl   $0xe8f,0x4(%esp)
 1b6:	00 
 ...
 265:	c7 44 24 04 6e 0e 00 	movl   $0xe6e,0x4(%esp)
 26c:	00 
 ...
 2af:	c7 44 24 04 82 0e 00 	movl   $0xe82,0x4(%esp)
 2b6:	00 
...
main(int argc, char *argv[])
{
 ...
 30f:	7f 11                	jg     322 <main+0x20>
    ls(".");
 311:	c7 04 24 a2 0e 00 00 	movl   $0xea2,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6f2:	0f b6 80 f0 0e 00 00 	movzbl 0xef0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 850:	75 27                	jne    879 <printf+0x120>
          s = "(null)";
 852:	c7 45 e4 a4 0e 00 00 	movl   $0xea4,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 91f:	a1 1c 0f 00 00       	mov    0xf1c,%eax
...
free(void *ap)
{
 ...
 9e0:	a3 1c 0f 00 00       	mov    %eax,0xf1c
}
 9e5:	c9                   	leave  
 9e6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a33:	e8 d8 fe ff ff       	call   910 <free>
  return freep;
 a38:	a1 1c 0f 00 00       	mov    0xf1c,%eax
}
 a3d:	c9                   	leave  
 a3e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a51:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 a54:	a1 1c 0f 00 00       	mov    0xf1c,%eax
 a59:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a5c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a60:	75 23                	jne    a85 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a62:	c7 45 f0 14 0f 00 00 	movl   $0xf14,-0x10(%ebp)
 a69:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a6c:	a3 1c 0f 00 00       	mov    %eax,0xf1c
 a71:	a1 1c 0f 00 00       	mov    0xf1c,%eax
 a76:	a3 14 0f 00 00       	mov    %eax,0xf14
    base.s.size = 0;
 a7b:	c7 05 18 0f 00 00 00 	movl   $0x0,0xf18
 a82:	00 00 00 
  }
 ...
 ad8:	a3 1c 0f 00 00       	mov    %eax,0xf1c
      return (void*)(p + 1);
 ...
 ae3:	eb 38                	jmp    b1d <malloc+0xde>
    ...
    if(p == freep)
 ae5:	a1 1c 0f 00 00       	mov    0xf1c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 bc4:	c7 44 24 04 ab 0e 00 	movl   $0xeab,0x4(%esp)
 bcb:	00 
 ...
 c09:	c7 44 24 04 b9 0e 00 	movl   $0xeb9,0x4(%esp)
 c10:	00 
 ...
 c35:	c7 44 24 04 c6 0e 00 	movl   $0xec6,0x4(%esp)
 c3c:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 d7f:	e8 cc fe ff ff       	call   c50 <init_q>
	lock_init(&s->lock);
 d84:	8b 45 08             	mov    0x8(%ebp),%eax
 d87:	83 c0 10             	add    $0x10,%eax
 d8a:	89 04 24             	mov    %eax,(%esp)
 d8d:	e8 a8 fd ff ff       	call   b3a <lock_init>
}
 d92:	c9                   	leave  
 d93:	c3                   	ret    

00000d94 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 da1:	7e 2c                	jle    dcf <sem_acquire+0x3b>
			//printf(1, "COUNT IS = %d\n", s->count);
			//printf(1, "acquiring lock\n");
			lock_acquire(&s->lock);									//acquire count lock
 da3:	8b 45 08             	mov    0x8(%ebp),%eax
 da6:	83 c0 10             	add    $0x10,%eax
 da9:	89 04 24             	mov    %eax,(%esp)
 dac:	e8 97 fd ff ff       	call   b48 <lock_acquire>
 ...
 dcf:	c7 44 24 04 d7 0e 00 	movl   $0xed7,0x4(%esp)
 dd6:	00 
 dd7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 dde:	e8 76 f9 ff ff       	call   759 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 de3:	e8 50 f8 ff ff       	call   638 <getpid>
 de8:	8b 55 08             	mov    0x8(%ebp),%edx
 deb:	83 c2 04             	add    $0x4,%edx
 dee:	89 44 24 04          	mov    %eax,0x4(%esp)
 df2:	89 14 24             	mov    %edx,(%esp)
 df5:	e8 78 fe ff ff       	call   c72 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 dfa:	e8 69 f8 ff ff       	call   668 <tsleep>
		}
	}
 dff:	eb 99                	jmp    d9a <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 e4b:	e8 9c fe ff ff       	call   cec <pop_q>
 e50:	89 04 24             	mov    %eax,(%esp)
 e53:	e8 18 f8 ff ff       	call   670 <twakeup>
	}
}
 e58:	c9                   	leave  
 e59:	c3                   	ret    
