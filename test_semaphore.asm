...
void temp_func(void *arg_ptr) {
   ...
   6:	c7 44 24 04 82 0b 00 	movl   $0xb82,0x4(%esp)
   d:	00 
   e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  15:	e8 67 04 00 00       	call   481 <printf>
	texit();
  1a:	e8 69 03 00 00       	call   388 <texit>
...
int main(){
  ...
  25:	83 ec 20             	sub    $0x20,%esp
	init_semaphore(&s, 1);
  28:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  2f:	00 
  30:	c7 04 24 18 0c 00 00 	movl   $0xc18,(%esp)
  37:	e8 54 0a 00 00       	call   a90 <init_semaphore>
	void *tid = thread_create(temp_func,(void *)0);
  3c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  43:	00 
  44:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  4b:	e8 5a 08 00 00       	call   8aa <thread_create>
  50:	89 44 24 1c          	mov    %eax,0x1c(%esp)
	if(tid == 0) {
  54:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  59:	75 19                	jne    74 <main+0x55>
		printf(1, "failed making thread :( \n");
  5b:	c7 44 24 04 92 0b 00 	movl   $0xb92,0x4(%esp)
  62:	00 
  63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6a:	e8 12 04 00 00       	call   481 <printf>
		exit();
  6f:	e8 6c 02 00 00       	call   2e0 <exit>
	}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	0f b6 80 f8 0b 00 00 	movzbl 0xbf8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 578:	75 27                	jne    5a1 <printf+0x120>
          s = "(null)";
 57a:	c7 45 e4 ac 0b 00 00 	movl   $0xbac,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 647:	a1 14 0c 00 00       	mov    0xc14,%eax
...
free(void *ap)
{
 ...
 708:	a3 14 0c 00 00       	mov    %eax,0xc14
}
 70d:	c9                   	leave  
 70e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75b:	e8 d8 fe ff ff       	call   638 <free>
  return freep;
 760:	a1 14 0c 00 00       	mov    0xc14,%eax
}
 765:	c9                   	leave  
 766:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 779:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 77c:	a1 14 0c 00 00       	mov    0xc14,%eax
 781:	89 45 f0             	mov    %eax,-0x10(%ebp)
 784:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 788:	75 23                	jne    7ad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78a:	c7 45 f0 0c 0c 00 00 	movl   $0xc0c,-0x10(%ebp)
 791:	8b 45 f0             	mov    -0x10(%ebp),%eax
 794:	a3 14 0c 00 00       	mov    %eax,0xc14
 799:	a1 14 0c 00 00       	mov    0xc14,%eax
 79e:	a3 0c 0c 00 00       	mov    %eax,0xc0c
    base.s.size = 0;
 7a3:	c7 05 10 0c 00 00 00 	movl   $0x0,0xc10
 7aa:	00 00 00 
  }
 ...
 800:	a3 14 0c 00 00       	mov    %eax,0xc14
      return (void*)(p + 1);
 ...
 80b:	eb 38                	jmp    845 <malloc+0xde>
    ...
    if(p == freep)
 80d:	a1 14 0c 00 00       	mov    0xc14,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8ec:	c7 44 24 04 b3 0b 00 	movl   $0xbb3,0x4(%esp)
 8f3:	00 
 ...
 931:	c7 44 24 04 c1 0b 00 	movl   $0xbc1,0x4(%esp)
 938:	00 
 ...
 95d:	c7 44 24 04 ce 0b 00 	movl   $0xbce,0x4(%esp)
 964:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 aa1:	83 c0 04             	add    $0x4,%eax
 aa4:	89 04 24             	mov    %eax,(%esp)
 aa7:	e8 cc fe ff ff       	call   978 <init_q>
	lock_init(&s->lock);
 aac:	8b 45 08             	mov    0x8(%ebp),%eax
 aaf:	83 c0 10             	add    $0x10,%eax
 ab2:	89 04 24             	mov    %eax,(%esp)
 ab5:	e8 a8 fd ff ff       	call   862 <lock_init>
}
 aba:	c9                   	leave  
 abb:	c3                   	ret    

00000abc <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 ae9:	83 c0 10             	add    $0x10,%eax
 aec:	89 04 24             	mov    %eax,(%esp)
 aef:	e8 9b fd ff ff       	call   88f <lock_release>
			break;
 af4:	90                   	nop
 ...
 af7:	c7 44 24 04 df 0b 00 	movl   $0xbdf,0x4(%esp)
 afe:	00 
 aff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b06:	e8 76 f9 ff ff       	call   481 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 b0b:	e8 50 f8 ff ff       	call   360 <getpid>
 b10:	8b 55 08             	mov    0x8(%ebp),%edx
 b13:	83 c2 04             	add    $0x4,%edx
 b16:	89 44 24 04          	mov    %eax,0x4(%esp)
 b1a:	89 14 24             	mov    %edx,(%esp)
 b1d:	e8 78 fe ff ff       	call   99a <add_q>
			//printf(1, "asleep \n");
			tsleep();
 b22:	e8 69 f8 ff ff       	call   390 <tsleep>
		}
	}
 b27:	eb 99                	jmp    ac2 <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 b38:	e8 33 fd ff ff       	call   870 <lock_acquire>
	s->count++;
 ...
 b73:	e8 9c fe ff ff       	call   a14 <pop_q>
 b78:	89 04 24             	mov    %eax,(%esp)
 b7b:	e8 18 f8 ff ff       	call   398 <twakeup>
	}
}
 b80:	c9                   	leave  
 b81:	c3                   	ret    
