...
cat(int fd)
{
  ...
  2a:	00 
  2b:	c7 44 24 04 c0 0c 00 	movl   $0xcc0,0x4(%esp)
  32:	00 
  ...
  4d:	c7 44 24 04 16 0c 00 	movl   $0xc16,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  c9:	c7 44 24 04 27 0c 00 	movl   $0xc27,0x4(%esp)
  d0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	0f b6 80 88 0c 00 00 	movzbl 0xc88(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 60c:	75 27                	jne    635 <printf+0x120>
          s = "(null)";
 60e:	c7 45 e4 3c 0c 00 00 	movl   $0xc3c,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6db:	a1 a8 0c 00 00       	mov    0xca8,%eax
...
free(void *ap)
{
 ...
 79c:	a3 a8 0c 00 00       	mov    %eax,0xca8
}
 7a1:	c9                   	leave  
 7a2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ef:	e8 d8 fe ff ff       	call   6cc <free>
  return freep;
 7f4:	a1 a8 0c 00 00       	mov    0xca8,%eax
}
 7f9:	c9                   	leave  
 7fa:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 80d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 810:	a1 a8 0c 00 00       	mov    0xca8,%eax
 815:	89 45 f0             	mov    %eax,-0x10(%ebp)
 818:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 81c:	75 23                	jne    841 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 81e:	c7 45 f0 a0 0c 00 00 	movl   $0xca0,-0x10(%ebp)
 825:	8b 45 f0             	mov    -0x10(%ebp),%eax
 828:	a3 a8 0c 00 00       	mov    %eax,0xca8
 82d:	a1 a8 0c 00 00       	mov    0xca8,%eax
 832:	a3 a0 0c 00 00       	mov    %eax,0xca0
    base.s.size = 0;
 837:	c7 05 a4 0c 00 00 00 	movl   $0x0,0xca4
 83e:	00 00 00 
  }
 ...
 894:	a3 a8 0c 00 00       	mov    %eax,0xca8
      return (void*)(p + 1);
 ...
 89f:	eb 38                	jmp    8d9 <malloc+0xde>
    ...
    if(p == freep)
 8a1:	a1 a8 0c 00 00       	mov    0xca8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 980:	c7 44 24 04 43 0c 00 	movl   $0xc43,0x4(%esp)
 987:	00 
 ...
 9c5:	c7 44 24 04 51 0c 00 	movl   $0xc51,0x4(%esp)
 9cc:	00 
 ...
 9f1:	c7 44 24 04 5e 0c 00 	movl   $0xc5e,0x4(%esp)
 9f8:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 b3b:	e8 cc fe ff ff       	call   a0c <init_q>
	lock_init(&s->lock);
 b40:	8b 45 08             	mov    0x8(%ebp),%eax
 b43:	83 c0 10             	add    $0x10,%eax
 b46:	89 04 24             	mov    %eax,(%esp)
 b49:	e8 a8 fd ff ff       	call   8f6 <lock_init>
}
 b4e:	c9                   	leave  
 b4f:	c3                   	ret    

00000b50 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 b7d:	83 c0 10             	add    $0x10,%eax
 b80:	89 04 24             	mov    %eax,(%esp)
 b83:	e8 9b fd ff ff       	call   923 <lock_release>
			break;
 b88:	90                   	nop
 ...
 b8b:	c7 44 24 04 6f 0c 00 	movl   $0xc6f,0x4(%esp)
 b92:	00 
 b93:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b9a:	e8 76 f9 ff ff       	call   515 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 b9f:	e8 50 f8 ff ff       	call   3f4 <getpid>
 ba4:	8b 55 08             	mov    0x8(%ebp),%edx
 ba7:	83 c2 04             	add    $0x4,%edx
 baa:	89 44 24 04          	mov    %eax,0x4(%esp)
 bae:	89 14 24             	mov    %edx,(%esp)
 bb1:	e8 78 fe ff ff       	call   a2e <add_q>
			//printf(1, "asleep \n");
			tsleep();
 bb6:	e8 69 f8 ff ff       	call   424 <tsleep>
		}
	}
 bbb:	eb 99                	jmp    b56 <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 bc6:	83 c0 10             	add    $0x10,%eax
 bc9:	89 04 24             	mov    %eax,(%esp)
 bcc:	e8 33 fd ff ff       	call   904 <lock_acquire>
	s->count++;
