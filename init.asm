...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 21 0c 00 00 	movl   $0xc21,(%esp)
  ...
  30:	00 
  31:	c7 04 24 21 0c 00 00 	movl   $0xc21,(%esp)
  38:	e8 87 03 00 00       	call   3c4 <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 21 0c 00 00 	movl   $0xc21,(%esp)
  ...
  6c:	c7 44 24 04 29 0c 00 	movl   $0xc29,0x4(%esp)
  73:	00 
  ...
  90:	c7 44 24 04 3c 0c 00 	movl   $0xc3c,0x4(%esp)
  97:	00 
  ...
  ae:	75 43                	jne    f3 <main+0xf3>
      exec("sh", argv);
  b0:	c7 44 24 04 b8 0c 00 	movl   $0xcb8,0x4(%esp)
  b7:	00 
  b8:	c7 04 24 1e 0c 00 00 	movl   $0xc1e,(%esp)
  bf:	e8 f0 02 00 00       	call   3b4 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	c7 44 24 04 4f 0c 00 	movl   $0xc4f,0x4(%esp)
  cb:	00 
  ...
  d8:	e8 9f 02 00 00       	call   37c <exit>
    ...
    while((wpid=wait()) >= 0 && wpid != pid)
      printf(1, "zombie!\n");
  dd:	c7 44 24 04 65 0c 00 	movl   $0xc65,0x4(%esp)
  e4:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b6:	0f b6 80 c0 0c 00 00 	movzbl 0xcc0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 614:	75 27                	jne    63d <printf+0x120>
          s = "(null)";
 616:	c7 45 e4 6e 0c 00 00 	movl   $0xc6e,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e3:	a1 dc 0c 00 00       	mov    0xcdc,%eax
...
free(void *ap)
{
 ...
 7a4:	a3 dc 0c 00 00       	mov    %eax,0xcdc
}
 7a9:	c9                   	leave  
 7aa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7f7:	e8 d8 fe ff ff       	call   6d4 <free>
  return freep;
 7fc:	a1 dc 0c 00 00       	mov    0xcdc,%eax
}
 801:	c9                   	leave  
 802:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 815:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 818:	a1 dc 0c 00 00       	mov    0xcdc,%eax
 81d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 820:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 824:	75 23                	jne    849 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 826:	c7 45 f0 d4 0c 00 00 	movl   $0xcd4,-0x10(%ebp)
 82d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 830:	a3 dc 0c 00 00       	mov    %eax,0xcdc
 835:	a1 dc 0c 00 00       	mov    0xcdc,%eax
 83a:	a3 d4 0c 00 00       	mov    %eax,0xcd4
    base.s.size = 0;
 83f:	c7 05 d8 0c 00 00 00 	movl   $0x0,0xcd8
 846:	00 00 00 
  }
 ...
 89c:	a3 dc 0c 00 00       	mov    %eax,0xcdc
      return (void*)(p + 1);
 ...
 8a7:	eb 38                	jmp    8e1 <malloc+0xde>
    ...
    if(p == freep)
 8a9:	a1 dc 0c 00 00       	mov    0xcdc,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 988:	c7 44 24 04 75 0c 00 	movl   $0xc75,0x4(%esp)
 98f:	00 
 ...
 9cd:	c7 44 24 04 83 0c 00 	movl   $0xc83,0x4(%esp)
 9d4:	00 
 ...
 9f9:	c7 44 24 04 90 0c 00 	movl   $0xc90,0x4(%esp)
 a00:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 b43:	e8 cc fe ff ff       	call   a14 <init_q>
	lock_init(&s->lock);
 b48:	8b 45 08             	mov    0x8(%ebp),%eax
 b4b:	83 c0 10             	add    $0x10,%eax
 b4e:	89 04 24             	mov    %eax,(%esp)
 b51:	e8 a8 fd ff ff       	call   8fe <lock_init>
}
 b56:	c9                   	leave  
 b57:	c3                   	ret    

00000b58 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 b85:	83 c0 10             	add    $0x10,%eax
 b88:	89 04 24             	mov    %eax,(%esp)
 b8b:	e8 9b fd ff ff       	call   92b <lock_release>
			break;
 b90:	90                   	nop
 ...
 b93:	c7 44 24 04 a1 0c 00 	movl   $0xca1,0x4(%esp)
 b9a:	00 
 b9b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 ba2:	e8 76 f9 ff ff       	call   51d <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 ba7:	e8 50 f8 ff ff       	call   3fc <getpid>
 bac:	8b 55 08             	mov    0x8(%ebp),%edx
 baf:	83 c2 04             	add    $0x4,%edx
 bb2:	89 44 24 04          	mov    %eax,0x4(%esp)
 bb6:	89 14 24             	mov    %edx,(%esp)
 bb9:	e8 78 fe ff ff       	call   a36 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 bbe:	e8 69 f8 ff ff       	call   42c <tsleep>
		}
	}
 bc3:	eb 99                	jmp    b5e <sem_acquire+0x6>
