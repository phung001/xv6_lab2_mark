...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 9e 0b 00 	movl   $0xb9e,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	0f b6 80 04 0c 00 00 	movzbl 0xc04(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 580:	75 27                	jne    5a9 <printf+0x120>
          s = "(null)";
 582:	c7 45 e4 b7 0b 00 00 	movl   $0xbb7,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64f:	a1 20 0c 00 00       	mov    0xc20,%eax
...
free(void *ap)
{
 ...
 710:	a3 20 0c 00 00       	mov    %eax,0xc20
}
 715:	c9                   	leave  
 716:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 763:	e8 d8 fe ff ff       	call   640 <free>
  return freep;
 768:	a1 20 0c 00 00       	mov    0xc20,%eax
}
 76d:	c9                   	leave  
 76e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 781:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 784:	a1 20 0c 00 00       	mov    0xc20,%eax
 789:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 790:	75 23                	jne    7b5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 792:	c7 45 f0 18 0c 00 00 	movl   $0xc18,-0x10(%ebp)
 799:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79c:	a3 20 0c 00 00       	mov    %eax,0xc20
 7a1:	a1 20 0c 00 00       	mov    0xc20,%eax
 7a6:	a3 18 0c 00 00       	mov    %eax,0xc18
    base.s.size = 0;
 7ab:	c7 05 1c 0c 00 00 00 	movl   $0x0,0xc1c
 7b2:	00 00 00 
  }
 ...
 808:	a3 20 0c 00 00       	mov    %eax,0xc20
      return (void*)(p + 1);
 ...
 813:	eb 38                	jmp    84d <malloc+0xde>
    ...
    if(p == freep)
 815:	a1 20 0c 00 00       	mov    0xc20,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8f4:	c7 44 24 04 be 0b 00 	movl   $0xbbe,0x4(%esp)
 8fb:	00 
 ...
 939:	c7 44 24 04 cc 0b 00 	movl   $0xbcc,0x4(%esp)
 940:	00 
 ...
 965:	c7 44 24 04 d9 0b 00 	movl   $0xbd9,0x4(%esp)
 96c:	00 
...
void sem_acquire(struct Semaphore *s) {
 ...
 aff:	c7 44 24 04 ea 0b 00 	movl   $0xbea,0x4(%esp)
 b06:	00 
