...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 8a 0b 00 	movl   $0xb8a,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 a1 0b 00 	movl   $0xba1,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	0f b6 80 08 0c 00 00 	movzbl 0xc08(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 580:	75 27                	jne    5a9 <printf+0x120>
          s = "(null)";
 582:	c7 45 e4 bd 0b 00 00 	movl   $0xbbd,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64f:	a1 24 0c 00 00       	mov    0xc24,%eax
...
free(void *ap)
{
 ...
 710:	a3 24 0c 00 00       	mov    %eax,0xc24
}
 715:	c9                   	leave  
 716:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 763:	e8 d8 fe ff ff       	call   640 <free>
  return freep;
 768:	a1 24 0c 00 00       	mov    0xc24,%eax
}
 76d:	c9                   	leave  
 76e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 781:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 784:	a1 24 0c 00 00       	mov    0xc24,%eax
 789:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 790:	75 23                	jne    7b5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 792:	c7 45 f0 1c 0c 00 00 	movl   $0xc1c,-0x10(%ebp)
 799:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79c:	a3 24 0c 00 00       	mov    %eax,0xc24
 7a1:	a1 24 0c 00 00       	mov    0xc24,%eax
 7a6:	a3 1c 0c 00 00       	mov    %eax,0xc1c
    base.s.size = 0;
 7ab:	c7 05 20 0c 00 00 00 	movl   $0x0,0xc20
 7b2:	00 00 00 
  }
 ...
 808:	a3 24 0c 00 00       	mov    %eax,0xc24
      return (void*)(p + 1);
 ...
 813:	eb 38                	jmp    84d <malloc+0xde>
    ...
    if(p == freep)
 815:	a1 24 0c 00 00       	mov    0xc24,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8f4:	c7 44 24 04 c4 0b 00 	movl   $0xbc4,0x4(%esp)
 8fb:	00 
 ...
 939:	c7 44 24 04 d2 0b 00 	movl   $0xbd2,0x4(%esp)
 940:	00 
 ...
 965:	c7 44 24 04 df 0b 00 	movl   $0xbdf,0x4(%esp)
 96c:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 aa9:	83 c0 04             	add    $0x4,%eax
 aac:	89 04 24             	mov    %eax,(%esp)
 aaf:	e8 cc fe ff ff       	call   980 <init_q>
	lock_init(&s->lock);
 ab4:	8b 45 08             	mov    0x8(%ebp),%eax
 ab7:	83 c0 10             	add    $0x10,%eax
 aba:	89 04 24             	mov    %eax,(%esp)
 abd:	e8 a8 fd ff ff       	call   86a <lock_init>
}
 ac2:	c9                   	leave  
 ac3:	c3                   	ret    

00000ac4 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 af1:	83 c0 10             	add    $0x10,%eax
 af4:	89 04 24             	mov    %eax,(%esp)
 af7:	e8 9b fd ff ff       	call   897 <lock_release>
			break;
 afc:	90                   	nop
 ...
 aff:	c7 44 24 04 f0 0b 00 	movl   $0xbf0,0x4(%esp)
 b06:	00 
 b07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 b0e:	e8 76 f9 ff ff       	call   489 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 b13:	e8 50 f8 ff ff       	call   368 <getpid>
 b18:	8b 55 08             	mov    0x8(%ebp),%edx
 b1b:	83 c2 04             	add    $0x4,%edx
 b1e:	89 44 24 04          	mov    %eax,0x4(%esp)
 b22:	89 14 24             	mov    %edx,(%esp)
 b25:	e8 78 fe ff ff       	call   9a2 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 b2a:	e8 69 f8 ff ff       	call   398 <tsleep>
		}
	}
 b2f:	eb 99                	jmp    aca <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 b7b:	e8 9c fe ff ff       	call   a1c <pop_q>
 b80:	89 04 24             	mov    %eax,(%esp)
 b83:	e8 18 f8 ff ff       	call   3a0 <twakeup>
	}
}
 b88:	c9                   	leave  
 b89:	c3                   	ret    
