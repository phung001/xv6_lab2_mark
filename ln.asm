...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 82 0b 00 	movl   $0xb82,0x4(%esp)
  16:	00 
  ...
  60:	c7 44 24 04 95 0b 00 	movl   $0xb95,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	0f b6 80 f4 0b 00 00 	movzbl 0xbf4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 578:	75 27                	jne    5a1 <printf+0x120>
          s = "(null)";
 57a:	c7 45 e4 a9 0b 00 00 	movl   $0xba9,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 647:	a1 10 0c 00 00       	mov    0xc10,%eax
...
free(void *ap)
{
 ...
 708:	a3 10 0c 00 00       	mov    %eax,0xc10
}
 70d:	c9                   	leave  
 70e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75b:	e8 d8 fe ff ff       	call   638 <free>
  return freep;
 760:	a1 10 0c 00 00       	mov    0xc10,%eax
}
 765:	c9                   	leave  
 766:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 78a:	c7 45 f0 08 0c 00 00 	movl   $0xc08,-0x10(%ebp)
 791:	8b 45 f0             	mov    -0x10(%ebp),%eax
 794:	a3 10 0c 00 00       	mov    %eax,0xc10
 799:	a1 10 0c 00 00       	mov    0xc10,%eax
 79e:	a3 08 0c 00 00       	mov    %eax,0xc08
    base.s.size = 0;
 7a3:	c7 05 0c 0c 00 00 00 	movl   $0x0,0xc0c
 7aa:	00 00 00 
  }
 ...
 800:	a3 10 0c 00 00       	mov    %eax,0xc10
      return (void*)(p + 1);
 ...
 80b:	eb 38                	jmp    845 <malloc+0xde>
    ...
    if(p == freep)
 80d:	a1 10 0c 00 00       	mov    0xc10,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8ec:	c7 44 24 04 b0 0b 00 	movl   $0xbb0,0x4(%esp)
 8f3:	00 
 ...
 931:	c7 44 24 04 be 0b 00 	movl   $0xbbe,0x4(%esp)
 938:	00 
 ...
 95d:	c7 44 24 04 cb 0b 00 	movl   $0xbcb,0x4(%esp)
 964:	00 
...
void sem_acquire(struct Semaphore *s) {
 ...
 af7:	c7 44 24 04 dc 0b 00 	movl   $0xbdc,0x4(%esp)
 afe:	00 
