...
wc(int fd, char *name)
{
  ...
  32:	0f b6 80 80 0d 00 00 	movzbl 0xd80(%eax),%eax
  39:	3c 0a                	cmp    $0xa,%al
  ...
  44:	0f b6 80 80 0d 00 00 	movzbl 0xd80(%eax),%eax
  4b:	0f be c0             	movsbl %al,%eax
  4e:	89 44 24 04          	mov    %eax,0x4(%esp)
  52:	c7 04 24 ca 0c 00 00 	movl   $0xcca,(%esp)
  ...
  8f:	00 
  90:	c7 44 24 04 80 0d 00 	movl   $0xd80,0x4(%esp)
  97:	00 
  ...
  b6:	c7 44 24 04 d0 0c 00 	movl   $0xcd0,0x4(%esp)
  bd:	00 
  ...
  eb:	c7 44 24 04 e0 0c 00 	movl   $0xce0,0x4(%esp)
  f2:	00 
...
main(int argc, char *argv[])
{
 ...
 10e:	7f 19                	jg     129 <main+0x28>
    wc(0, "");
 110:	c7 44 24 04 ed 0c 00 	movl   $0xced,0x4(%esp)
 117:	00 
 ...
 16a:	c7 44 24 04 ee 0c 00 	movl   $0xcee,0x4(%esp)
 171:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 562:	0f b6 80 4c 0d 00 00 	movzbl 0xd4c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6c0:	75 27                	jne    6e9 <printf+0x120>
          s = "(null)";
 6c2:	c7 45 e4 02 0d 00 00 	movl   $0xd02,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 78f:	a1 68 0d 00 00       	mov    0xd68,%eax
...
free(void *ap)
{
 ...
 850:	a3 68 0d 00 00       	mov    %eax,0xd68
}
 855:	c9                   	leave  
 856:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8a3:	e8 d8 fe ff ff       	call   780 <free>
  return freep;
 8a8:	a1 68 0d 00 00       	mov    0xd68,%eax
}
 8ad:	c9                   	leave  
 8ae:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 8c4:	a1 68 0d 00 00       	mov    0xd68,%eax
 8c9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8cc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8d0:	75 23                	jne    8f5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8d2:	c7 45 f0 60 0d 00 00 	movl   $0xd60,-0x10(%ebp)
 8d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8dc:	a3 68 0d 00 00       	mov    %eax,0xd68
 8e1:	a1 68 0d 00 00       	mov    0xd68,%eax
 8e6:	a3 60 0d 00 00       	mov    %eax,0xd60
    base.s.size = 0;
 ...
 948:	a3 68 0d 00 00       	mov    %eax,0xd68
      return (void*)(p + 1);
 ...
 953:	eb 38                	jmp    98d <malloc+0xde>
    ...
    if(p == freep)
 955:	a1 68 0d 00 00       	mov    0xd68,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 a34:	c7 44 24 04 09 0d 00 	movl   $0xd09,0x4(%esp)
 a3b:	00 
 ...
 a79:	c7 44 24 04 17 0d 00 	movl   $0xd17,0x4(%esp)
 a80:	00 
 ...
 aa5:	c7 44 24 04 24 0d 00 	movl   $0xd24,0x4(%esp)
 aac:	00 
...
void sem_acquire(struct Semaphore *s) {
 ...
 c3f:	c7 44 24 04 35 0d 00 	movl   $0xd35,0x4(%esp)
 c46:	00 
 c47:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 c4e:	e8 76 f9 ff ff       	call   5c9 <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 c53:	e8 50 f8 ff ff       	call   4a8 <getpid>
 c58:	8b 55 08             	mov    0x8(%ebp),%edx
 c5b:	83 c2 04             	add    $0x4,%edx
 c5e:	89 44 24 04          	mov    %eax,0x4(%esp)
 c62:	89 14 24             	mov    %edx,(%esp)
 c65:	e8 78 fe ff ff       	call   ae2 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 c6a:	e8 69 f8 ff ff       	call   4d8 <tsleep>
		}
	}
 c6f:	eb 99                	jmp    c0a <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 cbb:	e8 9c fe ff ff       	call   b5c <pop_q>
 cc0:	89 04 24             	mov    %eax,(%esp)
 cc3:	e8 18 f8 ff ff       	call   4e0 <twakeup>
	}
}
 cc8:	c9                   	leave  
 cc9:	c3                   	ret    
