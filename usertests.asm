...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 e0 5b 00 00       	mov    0x5be0,%eax
       b:	c7 44 24 04 d6 44 00 	movl   $0x44d6,0x4(%esp)
      12:	00 
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 e0 5b 00 00       	mov    0x5be0,%eax
      3d:	c7 44 24 04 e1 44 00 	movl   $0x44e1,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 f4 44 00 00 	movl   $0x44f4,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 e0 5b 00 00       	mov    0x5be0,%eax
      7f:	c7 44 24 04 01 45 00 	movl   $0x4501,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 e0 5b 00 00       	mov    0x5be0,%eax
      99:	c7 44 24 04 1f 45 00 	movl   $0x451f,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 e0 5b 00 00       	mov    0x5be0,%eax
      b6:	c7 44 24 04 2d 45 00 	movl   $0x452d,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 3e 45 00 00 	movl   $0x453e,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 e0 5b 00 00       	mov    0x5be0,%eax
      e8:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     109:	c7 44 24 04 5f 45 00 	movl   $0x455f,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 7b 45 00 	movl   $0x457b,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 88 45 00 	movl   $0x4588,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 b8 45 00 	movl   $0x45b8,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     1b3:	c7 44 24 04 dc 45 00 	movl   $0x45dc,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 3e 45 00 00 	movl   $0x453e,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     1f0:	c7 44 24 04 e7 45 00 	movl   $0x45e7,0x4(%esp)
     1f7:	00 
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     22e:	c7 44 24 04 00 46 00 	movl   $0x4600,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     248:	c7 44 24 04 1b 46 00 	movl   $0x461b,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 3e 45 00 00 	movl   $0x453e,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     27a:	c7 44 24 04 2e 46 00 	movl   $0x462e,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     294:	c7 44 24 04 3b 46 00 	movl   $0x463b,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     2ae:	c7 44 24 04 50 46 00 	movl   $0x4650,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     2cb:	c7 44 24 04 64 46 00 	movl   $0x4664,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 74 46 00 00 	movl   $0x4674,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     2fd:	c7 44 24 04 78 46 00 	movl   $0x4678,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     34c:	8b 55 ec             	mov    -0x14(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 92 46 00 	movl   $0x4692,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 74 46 00 00 	movl   $0x4674,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     3a3:	c7 44 24 04 b0 46 00 	movl   $0x46b0,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3f0:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     3f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 c9 46 00 	movl   $0x46c9,0x4(%esp)
     403:	00 
     ...
     41a:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     41f:	8b 55 ec             	mov    -0x14(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 e6 46 00 	movl   $0x46e6,0x4(%esp)
     42d:	00 
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 74 46 00 00 	movl   $0x4674,(%esp)
     48f:	e8 d8 37 00 00       	call   3c6c <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     49d:	c7 44 24 04 18 47 00 	movl   $0x4718,0x4(%esp)
     4a4:	00 
  ...
  printf(stdout, "big files ok\n");
     4b2:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     4b7:	c7 44 24 04 2b 47 00 	movl   $0x472b,0x4(%esp)
     4be:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     4d4:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 d9 38 00 00       	call   3dbd <printf>

  name[0] = 'a';
     4e4:	c6 05 c0 a3 00 00 61 	movb   $0x61,0xa3c0
  name[2] = '\0';
     4eb:	c6 05 c2 a3 00 00 00 	movb   $0x0,0xa3c2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     501:	a2 c1 a3 00 00       	mov    %al,0xa3c1
    fd = open(name, O_CREATE|O_RDWR);
     506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50d:	00 
     50e:	c7 04 24 c0 a3 00 00 	movl   $0xa3c0,(%esp)
  ...
  name[0] = 'a';
     532:	c6 05 c0 a3 00 00 61 	movb   $0x61,0xa3c0
  name[2] = '\0';
     539:	c6 05 c2 a3 00 00 00 	movb   $0x0,0xa3c2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     54f:	a2 c1 a3 00 00       	mov    %al,0xa3c1
    unlink(name);
     554:	c7 04 24 c0 a3 00 00 	movl   $0xa3c0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     56f:	c7 44 24 04 64 47 00 	movl   $0x4764,0x4(%esp)
     576:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     58c:	c7 44 24 04 8a 47 00 	movl   $0x478a,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 21 38 00 00       	call   3dbd <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 96 47 00 00 	movl   $0x4796,(%esp)
     5a3:	e8 dc 36 00 00       	call   3c84 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     5b1:	c7 44 24 04 9b 47 00 	movl   $0x479b,0x4(%esp)
     5b8:	00 
  ...
  if(chdir("dir0") < 0){
     5c6:	c7 04 24 96 47 00 00 	movl   $0x4796,(%esp)
     5cd:	e8 ba 36 00 00       	call   3c8c <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     5db:	c7 44 24 04 a9 47 00 	movl   $0x47a9,0x4(%esp)
     5e2:	00 
  ...
  if(chdir("..") < 0){
     5f0:	c7 04 24 bc 47 00 00 	movl   $0x47bc,(%esp)
     5f7:	e8 90 36 00 00       	call   3c8c <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     605:	c7 44 24 04 bf 47 00 	movl   $0x47bf,0x4(%esp)
     60c:	00 
  ...
  if(unlink("dir0") < 0){
     61a:	c7 04 24 96 47 00 00 	movl   $0x4796,(%esp)
     621:	e8 46 36 00 00       	call   3c6c <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     62f:	c7 44 24 04 d0 47 00 	movl   $0x47d0,0x4(%esp)
     636:	00 
  ...
  printf(stdout, "mkdir test\n");
     644:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     649:	c7 44 24 04 8a 47 00 	movl   $0x478a,0x4(%esp)
     650:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     666:	c7 44 24 04 e4 47 00 	movl   $0x47e4,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 47 37 00 00       	call   3dbd <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 cc 5b 00 	movl   $0x5bcc,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
     685:	e8 ca 35 00 00       	call   3c54 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 e0 5b 00 00       	mov    0x5be0,%eax
     693:	c7 44 24 04 ef 47 00 	movl   $0x47ef,0x4(%esp)
     69a:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 01 48 00 	movl   $0x4801,0x4(%esp)
     6c6:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     714:	88 90 c0 83 00 00    	mov    %dl,0x83c0(%eax)
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     735:	00 
     736:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     73d:	00 
     ...
     74d:	c7 44 24 04 10 48 00 	movl   $0x4810,0x4(%esp)
     754:	00 
     755:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75c:	e8 5c 36 00 00       	call   3dbd <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7a6:	0f b6 80 c0 83 00 00 	movzbl 0x83c0(%eax),%eax
     ...
     7c5:	c7 44 24 04 1e 48 00 	movl   $0x481e,0x4(%esp)
     7cc:	00 
     7cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d4:	e8 e4 35 00 00       	call   3dbd <printf>
          return;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     80e:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     815:	00 
    ...
    if(total != 5 * 1033){
     ...
     83b:	c7 44 24 04 2c 48 00 	movl   $0x482c,0x4(%esp)
     842:	00 
     843:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84a:	e8 6e 35 00 00       	call   3dbd <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     864:	c7 44 24 04 43 48 00 	movl   $0x4843,0x4(%esp)
     86b:	00 
     86c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     873:	e8 45 35 00 00       	call   3dbd <printf>
    ...
    printf(1, "fork() failed\n");
     87a:	c7 44 24 04 4d 48 00 	movl   $0x484d,0x4(%esp)
     881:	00 
     882:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     889:	e8 2f 35 00 00       	call   3dbd <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89b:	c7 44 24 04 5c 48 00 	movl   $0x485c,0x4(%esp)
     8a2:	00 
     8a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8aa:	e8 0e 35 00 00       	call   3dbd <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     8fd:	00 
     8fe:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
     905:	00 
     ...
     913:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     91a:	00 
     91b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     922:	e8 96 34 00 00       	call   3dbd <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     949:	00 
     94a:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     951:	00 
    ...
    printf(1, "preempt read error");
     95f:	c7 44 24 04 7c 48 00 	movl   $0x487c,0x4(%esp)
     966:	00 
     967:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     96e:	e8 4a 34 00 00       	call   3dbd <printf>
    return;
  ...
  printf(1, "kill... ");
     980:	c7 44 24 04 8f 48 00 	movl   $0x488f,0x4(%esp)
     987:	00 
     988:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     98f:	e8 29 34 00 00       	call   3dbd <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b5:	c7 44 24 04 98 48 00 	movl   $0x4898,0x4(%esp)
     9bc:	00 
     9bd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c4:	e8 f4 33 00 00       	call   3dbd <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9d8:	c7 44 24 04 a1 48 00 	movl   $0x48a1,0x4(%esp)
     9df:	00 
     9e0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9e7:	e8 d1 33 00 00       	call   3dbd <printf>
}
     9ec:	c9                   	leave  
     9ed:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a09:	79 16                	jns    a21 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0b:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
     a12:	00 
     a13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1a:	e8 9e 33 00 00       	call   3dbd <printf>
      return;
    ...
    if(pid){
     ...
     a31:	c7 44 24 04 ba 48 00 	movl   $0x48ba,0x4(%esp)
     a38:	00 
     a39:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a40:	e8 78 33 00 00       	call   3dbd <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a56:	c7 44 24 04 ca 48 00 	movl   $0x48ca,0x4(%esp)
     a5d:	00 
     a5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a65:	e8 53 33 00 00       	call   3dbd <printf>
}
     a6a:	c9                   	leave  
     a6b:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a72:	c7 44 24 04 d7 48 00 	movl   $0x48d7,0x4(%esp)
     a79:	00 
     a7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a81:	e8 37 33 00 00       	call   3dbd <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     abe:	e8 e0 35 00 00       	call   40a3 <malloc>
    ...
    while(m1){
     ...
     adc:	e8 93 34 00 00       	call   3f74 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     af4:	e8 aa 35 00 00       	call   40a3 <malloc>
    ...
    if(m1 == 0){
     ...
     b11:	e8 a7 32 00 00       	call   3dbd <printf>
      kill(ppid);
    ...
    free(m1);
     ...
     b2c:	e8 43 34 00 00       	call   3f74 <free>
    printf(1, "mem ok\n");
     b31:	c7 44 24 04 fb 48 00 	movl   $0x48fb,0x4(%esp)
     b38:	00 
     b39:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b40:	e8 78 32 00 00       	call   3dbd <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b57:	c7 44 24 04 03 49 00 	movl   $0x4903,0x4(%esp)
     b5e:	00 
     b5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b66:	e8 52 32 00 00       	call   3dbd <printf>

  unlink("sharedfd");
     b6b:	c7 04 24 12 49 00 00 	movl   $0x4912,(%esp)
     b72:	e8 f5 30 00 00       	call   3c6c <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b77:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b7e:	00 
     b7f:	c7 04 24 12 49 00 00 	movl   $0x4912,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b94:	c7 44 24 04 1c 49 00 	movl   $0x491c,0x4(%esp)
     b9b:	00 
     b9c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba3:	e8 15 32 00 00       	call   3dbd <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c06:	c7 44 24 04 48 49 00 	movl   $0x4948,0x4(%esp)
     c0d:	00 
     c0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c15:	e8 a3 31 00 00       	call   3dbd <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4b:	00 
     c4c:	c7 04 24 12 49 00 00 	movl   $0x4912,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c61:	c7 44 24 04 68 49 00 	movl   $0x4968,0x4(%esp)
     c68:	00 
     c69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c70:	e8 48 31 00 00       	call   3dbd <printf>
    return;
  ...
  unlink("sharedfd");
     cec:	c7 04 24 12 49 00 00 	movl   $0x4912,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0a:	c7 44 24 04 93 49 00 	movl   $0x4993,0x4(%esp)
     d11:	00 
     d12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d19:	e8 9f 30 00 00       	call   3dbd <printf>
        np++;
    }
  }
  close(fd);
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d2f:	c7 44 24 04 a0 49 00 	movl   $0x49a0,0x4(%esp)
     d36:	00 
     d37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d3e:	e8 7a 30 00 00       	call   3dbd <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d50:	c7 44 24 04 b5 49 00 	movl   $0x49b5,0x4(%esp)
     d57:	00 
     d58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d5f:	e8 59 30 00 00       	call   3dbd <printf>

  unlink("f1");
     d64:	c7 04 24 c4 49 00 00 	movl   $0x49c4,(%esp)
     d6b:	e8 fc 2e 00 00       	call   3c6c <unlink>
  unlink("f2");
     d70:	c7 04 24 c7 49 00 00 	movl   $0x49c7,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8a:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
     d91:	00 
     d92:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d99:	e8 1f 30 00 00       	call   3dbd <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     da9:	b8 c4 49 00 00       	mov    $0x49c4,%eax
     dae:	eb 05                	jmp    db5 <twofiles+0x6b>
     db0:	b8 c7 49 00 00       	mov    $0x49c7,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd4:	c7 44 24 04 ca 49 00 	movl   $0x49ca,0x4(%esp)
     ddb:	00 
     ddc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de3:	e8 d5 2f 00 00       	call   3dbd <printf>
    exit();
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e0b:	c7 04 24 c0 83 00 00 	movl   $0x83c0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e27:	00 
     e28:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     e2f:	00 
     ...
     e4e:	c7 44 24 04 d9 49 00 	movl   $0x49d9,0x4(%esp)
     e55:	00 
     e56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e5d:	e8 5b 2f 00 00       	call   3dbd <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     e9e:	b8 c4 49 00 00       	mov    $0x49c4,%eax
     ea3:	eb 05                	jmp    eaa <twofiles+0x160>
     ea5:	b8 c7 49 00 00       	mov    $0x49c7,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ed2:	0f b6 80 c0 83 00 00 	movzbl 0x83c0(%eax),%eax
     ...
     ef0:	74 19                	je     f0b <twofiles+0x1c1>
          printf(1, "wrong char\n");
     ef2:	c7 44 24 04 ea 49 00 	movl   $0x49ea,0x4(%esp)
     ef9:	00 
     efa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f01:	e8 b7 2e 00 00       	call   3dbd <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f24:	00 
     f25:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
     f2c:	00 
    ...
    if(total != 12*500){
     ...
     f5c:	c7 44 24 04 f6 49 00 	movl   $0x49f6,0x4(%esp)
     f63:	00 
     f64:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f6b:	e8 4d 2e 00 00       	call   3dbd <printf>
      exit();
  ...
  unlink("f1");
     f83:	c7 04 24 c4 49 00 00 	movl   $0x49c4,(%esp)
     f8a:	e8 dd 2c 00 00       	call   3c6c <unlink>
  unlink("f2");
     f8f:	c7 04 24 c7 49 00 00 	movl   $0x49c7,(%esp)
     f96:	e8 d1 2c 00 00       	call   3c6c <unlink>

  printf(1, "twofiles ok\n");
     f9b:	c7 44 24 04 07 4a 00 	movl   $0x4a07,0x4(%esp)
     fa2:	00 
     fa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faa:	e8 0e 2e 00 00       	call   3dbd <printf>
}
     faf:	c9                   	leave  
     fb0:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fb7:	c7 44 24 04 14 4a 00 	movl   $0x4a14,0x4(%esp)
     fbe:	00 
     fbf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fc6:	e8 f2 2d 00 00       	call   3dbd <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fd9:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
     fe0:	00 
     fe1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe8:	e8 d0 2d 00 00       	call   3dbd <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103a:	79 19                	jns    1055 <createdelete+0xa4>
      printf(1, "create failed\n");
    103c:	c7 44 24 04 ca 49 00 	movl   $0x49ca,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 6d 2d 00 00       	call   3dbd <printf>
      exit();
    ...
    1092:	c7 44 24 04 27 4a 00 	movl   $0x4a27,0x4(%esp)
    1099:	00 
    109a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a1:	e8 17 2d 00 00       	call   3dbd <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1111:	c7 44 24 04 38 4a 00 	movl   $0x4a38,0x4(%esp)
    1118:	00 
    1119:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1120:	e8 98 2c 00 00       	call   3dbd <printf>
      exit();
    ...
    1143:	c7 44 24 04 5c 4a 00 	movl   $0x4a5c,0x4(%esp)
    114a:	00 
    114b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1152:	e8 66 2c 00 00       	call   3dbd <printf>
      exit();
    ...
    11a9:	c7 44 24 04 38 4a 00 	movl   $0x4a38,0x4(%esp)
    11b0:	00 
    11b1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11b8:	e8 00 2c 00 00       	call   3dbd <printf>
      exit();
    ...
    11db:	c7 44 24 04 5c 4a 00 	movl   $0x4a5c,0x4(%esp)
    11e2:	00 
    11e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ea:	e8 ce 2b 00 00       	call   3dbd <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    124d:	c7 44 24 04 7c 4a 00 	movl   $0x4a7c,0x4(%esp)
    1254:	00 
    1255:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    125c:	e8 5c 2b 00 00       	call   3dbd <printf>
}
    1261:	c9                   	leave  
    1262:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1269:	c7 44 24 04 8d 4a 00 	movl   $0x4a8d,0x4(%esp)
    1270:	00 
    1271:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1278:	e8 40 2b 00 00       	call   3dbd <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    127d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1284:	00 
    1285:	c7 04 24 9e 4a 00 00 	movl   $0x4a9e,(%esp)
  ...
  if(fd < 0){
    ...
    129a:	c7 44 24 04 a9 4a 00 	movl   $0x4aa9,0x4(%esp)
    12a1:	00 
    12a2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12a9:	e8 0f 2b 00 00       	call   3dbd <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12ba:	00 
    12bb:	c7 44 24 04 c3 4a 00 	movl   $0x4ac3,0x4(%esp)
    12c2:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e0:	00 
    12e1:	c7 04 24 9e 4a 00 00 	movl   $0x4a9e,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    137c:	00 
    137d:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    1384:	00 
    ...
    1395:	c7 44 24 04 ff 4a 00 	movl   $0x4aff,0x4(%esp)
    139c:	00 
    139d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a4:	e8 14 2a 00 00       	call   3dbd <printf>
    exit();
    13a9:	e8 6e 28 00 00       	call   3c1c <exit>
  }
  if(buf[0] != 'h'){
    13ae:	0f b6 05 c0 83 00 00 	movzbl 0x83c0,%eax
    13b5:	3c 68                	cmp    $0x68,%al
    13b7:	74 19                	je     13d2 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13b9:	c7 44 24 04 16 4b 00 	movl   $0x4b16,0x4(%esp)
    13c0:	00 
    13c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13c8:	e8 f0 29 00 00       	call   3dbd <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13d9:	00 
    13da:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    13e1:	00 
    ...
    13f2:	c7 44 24 04 2d 4b 00 	movl   $0x4b2d,0x4(%esp)
    13f9:	00 
    13fa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1401:	e8 b7 29 00 00       	call   3dbd <printf>
    exit();
  ...
  unlink("unlinkread");
    1416:	c7 04 24 9e 4a 00 00 	movl   $0x4a9e,(%esp)
    141d:	e8 4a 28 00 00       	call   3c6c <unlink>
  printf(1, "unlinkread ok\n");
    1422:	c7 44 24 04 46 4b 00 	movl   $0x4b46,0x4(%esp)
    1429:	00 
    142a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1431:	e8 87 29 00 00       	call   3dbd <printf>
}
    1436:	c9                   	leave  
    1437:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    143e:	c7 44 24 04 55 4b 00 	movl   $0x4b55,0x4(%esp)
    1445:	00 
    1446:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    144d:	e8 6b 29 00 00       	call   3dbd <printf>

  unlink("lf1");
    1452:	c7 04 24 5f 4b 00 00 	movl   $0x4b5f,(%esp)
    1459:	e8 0e 28 00 00       	call   3c6c <unlink>
  unlink("lf2");
    145e:	c7 04 24 63 4b 00 00 	movl   $0x4b63,(%esp)
    1465:	e8 02 28 00 00       	call   3c6c <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1471:	00 
    1472:	c7 04 24 5f 4b 00 00 	movl   $0x4b5f,(%esp)
  ...
  if(fd < 0){
    ...
    1487:	c7 44 24 04 67 4b 00 	movl   $0x4b67,0x4(%esp)
    148e:	00 
    148f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1496:	e8 22 29 00 00       	call   3dbd <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14a7:	00 
    14a8:	c7 44 24 04 c3 4a 00 	movl   $0x4ac3,0x4(%esp)
    14af:	00 
    ...
    14c0:	c7 44 24 04 7a 4b 00 	movl   $0x4b7a,0x4(%esp)
    14c7:	00 
    14c8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14cf:	e8 e9 28 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1559:	00 
    155a:	c7 04 24 63 4b 00 00 	movl   $0x4b63,(%esp)
  ...
  if(fd < 0){
    ...
    156f:	c7 44 24 04 c9 4b 00 	movl   $0x4bc9,0x4(%esp)
    1576:	00 
    1577:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    157e:	e8 3a 28 00 00       	call   3dbd <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    158f:	00 
    1590:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    1597:	00 
    ...
    15a8:	c7 44 24 04 da 4b 00 	movl   $0x4bda,0x4(%esp)
    15af:	00 
    15b0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15b7:	e8 01 28 00 00       	call   3dbd <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15cc:	c7 44 24 04 63 4b 00 	movl   $0x4b63,0x4(%esp)
    15d3:	00 
    15d4:	c7 04 24 63 4b 00 00 	movl   $0x4b63,(%esp)
    15db:	e8 9c 26 00 00       	call   3c7c <link>
    15e0:	85 c0                	test   %eax,%eax
    15e2:	78 19                	js     15fd <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e4:	c7 44 24 04 eb 4b 00 	movl   $0x4beb,0x4(%esp)
    15eb:	00 
    15ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f3:	e8 c5 27 00 00       	call   3dbd <printf>
    exit();
    15f8:	e8 1f 26 00 00       	call   3c1c <exit>
  }

  unlink("lf2");
    15fd:	c7 04 24 63 4b 00 00 	movl   $0x4b63,(%esp)
    1604:	e8 63 26 00 00       	call   3c6c <unlink>
  if(link("lf2", "lf1") >= 0){
    1609:	c7 44 24 04 5f 4b 00 	movl   $0x4b5f,0x4(%esp)
    1610:	00 
    1611:	c7 04 24 63 4b 00 00 	movl   $0x4b63,(%esp)
    1618:	e8 5f 26 00 00       	call   3c7c <link>
    161d:	85 c0                	test   %eax,%eax
    161f:	78 19                	js     163a <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1621:	c7 44 24 04 0c 4c 00 	movl   $0x4c0c,0x4(%esp)
    1628:	00 
    1629:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1630:	e8 88 27 00 00       	call   3dbd <printf>
    exit();
    1635:	e8 e2 25 00 00       	call   3c1c <exit>
  }

  if(link(".", "lf1") >= 0){
    163a:	c7 44 24 04 5f 4b 00 	movl   $0x4b5f,0x4(%esp)
    1641:	00 
    1642:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
    1649:	e8 2e 26 00 00       	call   3c7c <link>
    164e:	85 c0                	test   %eax,%eax
    1650:	78 19                	js     166b <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1652:	c7 44 24 04 31 4c 00 	movl   $0x4c31,0x4(%esp)
    1659:	00 
    165a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1661:	e8 57 27 00 00       	call   3dbd <printf>
    exit();
    1666:	e8 b1 25 00 00       	call   3c1c <exit>
  }

  printf(1, "linktest ok\n");
    166b:	c7 44 24 04 4d 4c 00 	movl   $0x4c4d,0x4(%esp)
    1672:	00 
    1673:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167a:	e8 3e 27 00 00       	call   3dbd <printf>
}
    167f:	c9                   	leave  
    1680:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1687:	c7 44 24 04 5a 4c 00 	movl   $0x4c5a,0x4(%esp)
    168e:	00 
    168f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1696:	e8 22 27 00 00       	call   3dbd <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fa:	c7 04 24 6a 4c 00 00 	movl   $0x4c6a,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    173d:	c7 04 24 6a 4c 00 00 	movl   $0x4c6a,(%esp)
    ...
    176e:	c7 44 24 04 6d 4c 00 	movl   $0x4c6d,0x4(%esp)
    1775:	00 
    1776:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    177d:	e8 3b 26 00 00       	call   3dbd <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d2:	00 
    17d3:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1834:	c7 44 24 04 89 4c 00 	movl   $0x4c89,0x4(%esp)
    183b:	00 
    183c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1843:	e8 75 25 00 00       	call   3dbd <printf>
        exit();
    ...
    1863:	c7 44 24 04 a2 4c 00 	movl   $0x4ca2,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1872:	e8 46 25 00 00       	call   3dbd <printf>
        exit();
  ...
  if(n != 40){
    ...
    18be:	c7 44 24 04 c0 4c 00 	movl   $0x4cc0,0x4(%esp)
    18c5:	00 
    18c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18cd:	e8 eb 24 00 00       	call   3dbd <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18f8:	79 19                	jns    1913 <concreate+0x292>
      printf(1, "fork failed\n");
    18fa:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
    1901:	00 
    1902:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1909:	e8 af 24 00 00       	call   3dbd <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a1a:	c7 44 24 04 f1 4c 00 	movl   $0x4cf1,0x4(%esp)
    1a21:	00 
    1a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a29:	e8 8f 23 00 00       	call   3dbd <printf>
}
    1a2e:	c9                   	leave  
    1a2f:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a36:	c7 44 24 04 ff 4c 00 	movl   $0x4cff,0x4(%esp)
    1a3d:	00 
    1a3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a45:	e8 73 23 00 00       	call   3dbd <printf>

  unlink("x");
    1a4a:	c7 04 24 66 48 00 00 	movl   $0x4866,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a64:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
    1a6b:	00 
    1a6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a73:	e8 45 23 00 00       	call   3dbd <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad2:	00 
    1ad3:	c7 04 24 66 48 00 00 	movl   $0x4866,(%esp)
    ...
    1b04:	75 16                	jne    1b1c <linkunlink+0xec>
      link("cat", "x");
    1b06:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
    1b0d:	00 
    1b0e:	c7 04 24 10 4d 00 00 	movl   $0x4d10,(%esp)
    1b15:	e8 62 21 00 00       	call   3c7c <link>
    1b1a:	eb 0c                	jmp    1b28 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b1c:	c7 04 24 66 48 00 00 	movl   $0x4866,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b41:	c7 44 24 04 14 4d 00 	movl   $0x4d14,0x4(%esp)
    1b48:	00 
    1b49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b50:	e8 68 22 00 00       	call   3dbd <printf>
}
    1b55:	c9                   	leave  
    1b56:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b62:	c7 44 24 04 23 4d 00 	movl   $0x4d23,0x4(%esp)
    1b69:	00 
    1b6a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b71:	e8 47 22 00 00       	call   3dbd <printf>
  unlink("bd");
    1b76:	c7 04 24 30 4d 00 00 	movl   $0x4d30,(%esp)
    1b7d:	e8 ea 20 00 00       	call   3c6c <unlink>

  fd = open("bd", O_CREATE);
    1b82:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b89:	00 
    1b8a:	c7 04 24 30 4d 00 00 	movl   $0x4d30,(%esp)
  ...
  if(fd < 0){
    ...
    1b9f:	c7 44 24 04 33 4d 00 	movl   $0x4d33,0x4(%esp)
    1ba6:	00 
    1ba7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bae:	e8 0a 22 00 00       	call   3dbd <printf>
    exit();
  ...
  unlink("bd");
    1c3d:	c7 04 24 30 4d 00 00 	movl   $0x4d30,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c95:	c7 44 24 04 5d 4d 00 	movl   $0x4d5d,0x4(%esp)
    1c9c:	00 
    1c9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca4:	e8 14 21 00 00       	call   3dbd <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cbb:	c7 44 24 04 72 4d 00 	movl   $0x4d72,0x4(%esp)
    1cc2:	00 
    1cc3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cca:	e8 ee 20 00 00       	call   3dbd <printf>
}
    1ccf:	c9                   	leave  
    1cd0:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cd7:	c7 44 24 04 7d 4d 00 	movl   $0x4d7d,0x4(%esp)
    1cde:	00 
    1cdf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce6:	e8 d2 20 00 00       	call   3dbd <printf>

  unlink("ff");
    1ceb:	c7 04 24 8a 4d 00 00 	movl   $0x4d8a,(%esp)
    1cf2:	e8 75 1f 00 00       	call   3c6c <unlink>
  if(mkdir("dd") != 0){
    1cf7:	c7 04 24 8d 4d 00 00 	movl   $0x4d8d,(%esp)
    1cfe:	e8 81 1f 00 00       	call   3c84 <mkdir>
    1d03:	85 c0                	test   %eax,%eax
    1d05:	74 19                	je     1d20 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d07:	c7 44 24 04 90 4d 00 	movl   $0x4d90,0x4(%esp)
    1d0e:	00 
    1d0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d16:	e8 a2 20 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d27:	00 
    1d28:	c7 04 24 a8 4d 00 00 	movl   $0x4da8,(%esp)
  ...
  if(fd < 0){
    ...
    1d3d:	c7 44 24 04 ae 4d 00 	movl   $0x4dae,0x4(%esp)
    1d44:	00 
    1d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d4c:	e8 6c 20 00 00       	call   3dbd <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d5d:	00 
    1d5e:	c7 44 24 04 8a 4d 00 	movl   $0x4d8a,0x4(%esp)
    1d65:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dd5:	00 
    1dd6:	c7 04 24 0c 4e 00 00 	movl   $0x4e0c,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 15 4e 00 	movl   $0x4e15,0x4(%esp)
    1df2:	00 
    1df3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dfa:	e8 be 1f 00 00       	call   3dbd <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e0b:	00 
    1e0c:	c7 44 24 04 2d 4e 00 	movl   $0x4e2d,0x4(%esp)
    1e13:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e31:	00 
    1e32:	c7 04 24 30 4e 00 00 	movl   $0x4e30,(%esp)
  ...
  if(fd < 0){
    ...
    1e47:	c7 44 24 04 3c 4e 00 	movl   $0x4e3c,0x4(%esp)
    1e4e:	00 
    1e4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e56:	e8 62 1f 00 00       	call   3dbd <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e67:	00 
    1e68:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    1e6f:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e84:	0f b6 05 c0 83 00 00 	movzbl 0x83c0,%eax
    1e8b:	3c 66                	cmp    $0x66,%al
    1e8d:	74 19                	je     1ea8 <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e8f:	c7 44 24 04 55 4e 00 	movl   $0x4e55,0x4(%esp)
    1e96:	00 
    1e97:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e9e:	e8 1a 1f 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fe9:	00 
    1fea:	c7 04 24 70 4e 00 00 	movl   $0x4e70,(%esp)
  ...
  if(fd < 0){
    ...
    1fff:	c7 44 24 04 3a 4f 00 	movl   $0x4f3a,0x4(%esp)
    2006:	00 
    2007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    200e:	e8 aa 1d 00 00       	call   3dbd <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    201f:	00 
    2020:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    2027:	00 
    ...
    2038:	c7 44 24 04 52 4f 00 	movl   $0x4f52,0x4(%esp)
    203f:	00 
    2040:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2047:	e8 71 1d 00 00       	call   3dbd <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    241d:	c7 44 24 04 cc 51 00 	movl   $0x51cc,0x4(%esp)
    2424:	00 
    2425:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    242c:	e8 8c 19 00 00       	call   3dbd <printf>

  unlink("bigwrite");
    2431:	c7 04 24 db 51 00 00 	movl   $0x51db,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2450:	00 
    2451:	c7 04 24 db 51 00 00 	movl   $0x51db,(%esp)
    ...
    2466:	c7 44 24 04 e4 51 00 	movl   $0x51e4,0x4(%esp)
    246d:	00 
    246e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2475:	e8 43 19 00 00       	call   3dbd <printf>
      exit();
    ...
    248f:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    2496:	00 
    ...
    24bb:	c7 44 24 04 fc 51 00 	movl   $0x51fc,0x4(%esp)
    24c2:	00 
    24c3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24ca:	e8 ee 18 00 00       	call   3dbd <printf>
        exit();
    ...
    unlink("bigwrite");
    24e9:	c7 04 24 db 51 00 00 	movl   $0x51db,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2509:	c7 44 24 04 0e 52 00 	movl   $0x520e,0x4(%esp)
    2510:	00 
    2511:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2518:	e8 a0 18 00 00       	call   3dbd <printf>
}
    251d:	c9                   	leave  
    251e:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2525:	c7 44 24 04 1b 52 00 	movl   $0x521b,0x4(%esp)
    252c:	00 
    252d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2534:	e8 84 18 00 00       	call   3dbd <printf>

  unlink("bigfile");
    2539:	c7 04 24 29 52 00 00 	movl   $0x5229,(%esp)
    2540:	e8 27 17 00 00       	call   3c6c <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2545:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    254c:	00 
    254d:	c7 04 24 29 52 00 00 	movl   $0x5229,(%esp)
  ...
  if(fd < 0){
    ...
    2562:	c7 44 24 04 31 52 00 	movl   $0x5231,0x4(%esp)
    2569:	00 
    256a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2571:	e8 47 18 00 00       	call   3dbd <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2593:	c7 04 24 c0 83 00 00 	movl   $0x83c0,(%esp)
    259a:	e8 d7 14 00 00       	call   3a76 <memset>
    if(write(fd, buf, 600) != 600){
    259f:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25a6:	00 
    25a7:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    25ae:	00 
    ...
    25c1:	c7 44 24 04 47 52 00 	movl   $0x5247,0x4(%esp)
    25c8:	00 
    25c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d0:	e8 e8 17 00 00       	call   3dbd <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25f6:	00 
    25f7:	c7 04 24 29 52 00 00 	movl   $0x5229,(%esp)
  ...
  if(fd < 0){
    ...
    260c:	c7 44 24 04 5d 52 00 	movl   $0x525d,0x4(%esp)
    2613:	00 
    2614:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    261b:	e8 9d 17 00 00       	call   3dbd <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    263a:	00 
    263b:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    2642:	00 
    ...
    2657:	c7 44 24 04 72 52 00 	movl   $0x5272,0x4(%esp)
    265e:	00 
    265f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2666:	e8 52 17 00 00       	call   3dbd <printf>
      exit();
    ...
    2683:	c7 44 24 04 87 52 00 	movl   $0x5287,0x4(%esp)
    268a:	00 
    268b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2692:	e8 26 17 00 00       	call   3dbd <printf>
      exit();
    2697:	e8 80 15 00 00       	call   3c1c <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    269c:	0f b6 05 c0 83 00 00 	movzbl 0x83c0,%eax
    ...
    26b7:	0f b6 05 eb 84 00 00 	movzbl 0x84eb,%eax
    ...
    26d2:	c7 44 24 04 9b 52 00 	movl   $0x529b,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 d7 16 00 00       	call   3dbd <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 b4 52 00 	movl   $0x52b4,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 9a 16 00 00       	call   3dbd <printf>
    exit();
    2723:	e8 f4 14 00 00       	call   3c1c <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 29 52 00 00 	movl   $0x5229,(%esp)
    272f:	e8 38 15 00 00       	call   3c6c <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 ce 52 00 	movl   $0x52ce,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 75 16 00 00       	call   3dbd <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 6c 53 00 00 	movl   $0x536c,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 9c 53 00 	movl   $0x539c,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 d6 15 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 dc 53 00 00 	movl   $0x53dc,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 0c 54 00 	movl   $0x540c,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 95 15 00 00       	call   3dbd <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 b5 55 00 	movl   $0x55b5,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 8b 13 00 00       	call   3dbd <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 c2 55 00 00 	movl   $0x55c2,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 ca 55 00 	movl   $0x55ca,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 5a 13 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 fb 55 00 00 	movl   $0x55fb,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 06 56 00 	movl   $0x5606,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 f0 12 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 fb 55 00 00 	movl   $0x55fb,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 2f 4c 00 00 	movl   $0x4c2f,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 a0 56 00 	movl   $0x56a0,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 d8 11 00 00       	call   3dbd <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 bf 56 00 	movl   $0x56bf,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 89 11 00 00       	call   3dbd <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 d3 56 00 	movl   $0x56d3,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 65 11 00 00       	call   3dbd <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 e3 56 00 	movl   $0x56e3,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 49 11 00 00       	call   3dbd <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 23 57 00 00 	movl   $0x5723,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 23 57 00 00 	movl   $0x5723,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 46 55 00 00 	movl   $0x5546,(%esp)
    2d63:	e8 24 0f 00 00       	call   3c8c <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 26 57 00 	movl   $0x5726,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 41 10 00 00       	call   3dbd <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 3a 57 00 	movl   $0x573a,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 25 10 00 00       	call   3dbd <printf>
    ...
    2db5:	e8 62 0e 00 00       	call   3c1c <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 48 57 00 	movl   $0x5748,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 d6 0f 00 00       	call   3dbd <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 6a 57 00 	movl   $0x576a,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 b4 0f 00 00       	call   3dbd <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 7e 57 00 	movl   $0x577e,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 87 0f 00 00       	call   3dbd <printf>
    exit();
    2e36:	e8 e1 0d 00 00       	call   3c1c <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 91 57 00 	movl   $0x5791,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 6e 0f 00 00       	call   3dbd <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    2e60:	c7 44 24 04 9f 57 00 	movl   $0x579f,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 4d 0f 00 00       	call   3dbd <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    ...
    2ec8:	c7 44 24 04 aa 57 00 	movl   $0x57aa,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 e5 0e 00 00       	call   3dbd <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    2f0c:	c7 44 24 04 c5 57 00 	movl   $0x57c5,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 a1 0e 00 00       	call   3dbd <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    2f4f:	c7 44 24 04 dc 57 00 	movl   $0x57dc,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 5e 0e 00 00       	call   3dbd <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    2faf:	c7 44 24 04 f8 57 00 	movl   $0x57f8,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 fe 0d 00 00       	call   3dbd <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    2ffa:	c7 44 24 04 36 58 00 	movl   $0x5836,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 b3 0d 00 00       	call   3dbd <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    ...
    303e:	c7 44 24 04 54 58 00 	movl   $0x5854,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 6f 0d 00 00       	call   3dbd <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    ...
    30a5:	c7 44 24 04 8c 58 00 	movl   $0x588c,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 08 0d 00 00       	call   3dbd <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    30c9:	c7 44 24 04 b4 58 00 	movl   $0x58b4,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 e4 0c 00 00       	call   3dbd <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    ...
    3128:	c7 44 24 04 e4 58 00 	movl   $0x58e4,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 85 0c 00 00       	call   3dbd <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3161:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 4c 0c 00 00       	call   3dbd <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 01 48 00 	movl   $0x4801,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 cc 0b 00 00       	call   3dbd <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    323f:	00 
    3240:	c7 44 24 04 66 48 00 	movl   $0x4866,0x4(%esp)
    3247:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e1:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    32e6:	c7 44 24 04 1e 59 00 	movl   $0x591e,0x4(%esp)
    32ed:	00 
    32ee:	89 04 24             	mov    %eax,(%esp)
    32f1:	e8 c7 0a 00 00       	call   3dbd <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    3329:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    332e:	c7 44 24 04 39 59 00 	movl   $0x5939,0x4(%esp)
    3335:	00 
    3336:	89 04 24             	mov    %eax,(%esp)
    3339:	e8 7f 0a 00 00       	call   3dbd <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    336f:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3374:	c7 44 24 04 47 59 00 	movl   $0x5947,0x4(%esp)
    337b:	00 
    337c:	89 04 24             	mov    %eax,(%esp)
    337f:	e8 39 0a 00 00       	call   3dbd <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e1:	c7 04 24 56 59 00 00 	movl   $0x5956,(%esp)
    33e8:	e8 8f 08 00 00       	call   3c7c <link>
    33ed:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f0:	74 1a                	je     340c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f2:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    33f7:	c7 44 24 04 61 59 00 	movl   $0x5961,0x4(%esp)
    33fe:	00 
    33ff:	89 04 24             	mov    %eax,(%esp)
    3402:	e8 b6 09 00 00       	call   3dbd <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    341f:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3424:	c7 44 24 04 7a 59 00 	movl   $0x597a,0x4(%esp)
    342b:	00 
    342c:	89 04 24             	mov    %eax,(%esp)
    342f:	e8 89 09 00 00       	call   3dbd <printf>
}
    3434:	c9                   	leave  
    3435:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343c:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3441:	c7 44 24 04 87 59 00 	movl   $0x5987,0x4(%esp)
    3448:	00 
    3449:	89 04 24             	mov    %eax,(%esp)
    344c:	e8 6c 09 00 00       	call   3dbd <printf>
  for(i = 0; i < sizeof(uninit); i++){
    3451:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    3458:	eb 2c                	jmp    3486 <bsstest+0x50>
    if(uninit[i] != '\0'){
    345a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    345d:	0f b6 80 a0 5c 00 00 	movzbl 0x5ca0(%eax),%eax
    3464:	84 c0                	test   %al,%al
    3466:	74 1a                	je     3482 <bsstest+0x4c>
      printf(stdout, "bss test failed\n");
    3468:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    346d:	c7 44 24 04 91 59 00 	movl   $0x5991,0x4(%esp)
    3474:	00 
    3475:	89 04 24             	mov    %eax,(%esp)
    3478:	e8 40 09 00 00       	call   3dbd <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3490:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3495:	c7 44 24 04 a2 59 00 	movl   $0x59a2,0x4(%esp)
    349c:	00 
    349d:	89 04 24             	mov    %eax,(%esp)
    34a0:	e8 18 09 00 00       	call   3dbd <printf>
}
    34a5:	c9                   	leave  
    34a6:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ad:	c7 04 24 af 59 00 00 	movl   $0x59af,(%esp)
  ...
  if(pid == 0){
    ...
    34d7:	c7 04 85 00 5c 00 00 	movl   $0x59bc,0x5c00(,%eax,4)
    34de:	bc 59 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34ea:	7e e8                	jle    34d4 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34ec:	c7 05 7c 5c 00 00 00 	movl   $0x0,0x5c7c
    34f3:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f6:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    34fb:	c7 44 24 04 99 5a 00 	movl   $0x5a99,0x4(%esp)
    3502:	00 
    3503:	89 04 24             	mov    %eax,(%esp)
    3506:	e8 b2 08 00 00       	call   3dbd <printf>
    exec("echo", args);
    350b:	c7 44 24 04 00 5c 00 	movl   $0x5c00,0x4(%esp)
    3512:	00 
    3513:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
    351a:	e8 35 07 00 00       	call   3c54 <exec>
    printf(stdout, "bigarg test ok\n");
    351f:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3524:	c7 44 24 04 a6 5a 00 	movl   $0x5aa6,0x4(%esp)
    352b:	00 
    352c:	89 04 24             	mov    %eax,(%esp)
    352f:	e8 89 08 00 00       	call   3dbd <printf>
    fd = open("bigarg-ok", O_CREATE);
    3534:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    353b:	00 
    353c:	c7 04 24 af 59 00 00 	movl   $0x59af,(%esp)
    ...
    3561:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    3566:	c7 44 24 04 b6 5a 00 	movl   $0x5ab6,0x4(%esp)
    356d:	00 
    356e:	89 04 24             	mov    %eax,(%esp)
    3571:	e8 47 08 00 00       	call   3dbd <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3587:	00 
    3588:	c7 04 24 af 59 00 00 	movl   $0x59af,(%esp)
  ...
  if(fd < 0){
    ...
    359d:	a1 e0 5b 00 00       	mov    0x5be0,%eax
    35a2:	c7 44 24 04 cf 5a 00 	movl   $0x5acf,0x4(%esp)
    35a9:	00 
    35aa:	89 04 24             	mov    %eax,(%esp)
    35ad:	e8 0b 08 00 00       	call   3dbd <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35c2:	c7 04 24 af 59 00 00 	movl   $0x59af,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35de:	c7 44 24 04 e4 5a 00 	movl   $0x5ae4,0x4(%esp)
    35e5:	00 
    35e6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35ed:	e8 cb 07 00 00       	call   3dbd <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36ce:	c7 44 24 04 f1 5a 00 	movl   $0x5af1,0x4(%esp)
    36d5:	00 
    36d6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36dd:	e8 db 06 00 00       	call   3dbd <printf>
    ...
    3705:	c7 44 24 04 fd 5a 00 	movl   $0x5afd,0x4(%esp)
    370c:	00 
    370d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3714:	e8 a4 06 00 00       	call   3dbd <printf>
      break;
    ...
    3729:	00 
    372a:	c7 44 24 04 c0 83 00 	movl   $0x83c0,0x4(%esp)
    3731:	00 
    ...
    375d:	c7 44 24 04 0d 5b 00 	movl   $0x5b0d,0x4(%esp)
    3764:	00 
    3765:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    376c:	e8 4c 06 00 00       	call   3dbd <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3879:	c7 44 24 04 1d 5b 00 	movl   $0x5b1d,0x4(%esp)
    3880:	00 
    3881:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3888:	e8 30 05 00 00       	call   3dbd <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3896:	a1 e4 5b 00 00       	mov    0x5be4,%eax
    389b:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38a1:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38a6:	a3 e4 5b 00 00       	mov    %eax,0x5be4
  return randstate;
    38ab:	a1 e4 5b 00 00       	mov    0x5be4,%eax
}
    38b0:	5d                   	pop    %ebp
    38b1:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3907:	00 
    3908:	c7 04 24 47 5b 00 00 	movl   $0x5b47,(%esp)
...
00003cdc <thread_yield>:
SYSCALL(thread_yield)
    3cdc:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3ce1:	cd 40                	int    $0x40
    3ce3:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3ce7:	83 ec 28             	sub    $0x28,%esp
    3cea:	8b 45 0c             	mov    0xc(%ebp),%eax
    3ced:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3cf0:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3cf7:	00 
    3cf8:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3cfb:	89 44 24 04          	mov    %eax,0x4(%esp)
    3cff:	8b 45 08             	mov    0x8(%ebp),%eax
    3d02:	89 04 24             	mov    %eax,(%esp)
    3d05:	e8 32 ff ff ff       	call   3c3c <write>
}
    3d0a:	c9                   	leave  
    3d0b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3d13:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d1a:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d1e:	74 17                	je     3d37 <printint+0x2b>
    3d20:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d24:	79 11                	jns    3d37 <printint+0x2b>
    neg = 1;
    3d26:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3d35:	eb 06                	jmp    3d3d <printint+0x31>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    3d37:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d3a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }

  i = 0;
    3d3d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  do{
    buf[i++] = digits[x % base];
    3d44:	8b 4d ec             	mov    -0x14(%ebp),%ecx
    3d47:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3d4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d4d:	ba 00 00 00 00       	mov    $0x0,%edx
    3d52:	f7 f3                	div    %ebx
    3d54:	89 d0                	mov    %edx,%eax
    3d56:	0f b6 80 e8 5b 00 00 	movzbl 0x5be8(%eax),%eax
    3d5d:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
    3d61:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  }while((x /= base) != 0);
    3d65:	8b 45 10             	mov    0x10(%ebp),%eax
    3d68:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    3d6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d6e:	ba 00 00 00 00       	mov    $0x0,%edx
    3d73:	f7 75 d4             	divl   -0x2c(%ebp)
    3d76:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d79:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3d7d:	75 c5                	jne    3d44 <printint+0x38>
  if(neg)
    3d7f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d83:	74 28                	je     3dad <printint+0xa1>
    buf[i++] = '-';
    3d85:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d88:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
    3d8d:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)

  while(--i >= 0)
    3d91:	eb 1a                	jmp    3dad <printint+0xa1>
    putc(fd, buf[i]);
    3d93:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d96:	0f b6 44 05 dc       	movzbl -0x24(%ebp,%eax,1),%eax
    3d9b:	0f be c0             	movsbl %al,%eax
    3d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3da2:	8b 45 08             	mov    0x8(%ebp),%eax
    3da5:	89 04 24             	mov    %eax,(%esp)
    3da8:	e8 37 ff ff ff       	call   3ce4 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dad:	83 6d ec 01          	subl   $0x1,-0x14(%ebp)
    3db1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3db5:	79 dc                	jns    3d93 <printint+0x87>
    putc(fd, buf[i]);
}
    3db7:	83 c4 44             	add    $0x44,%esp
    3dba:	5b                   	pop    %ebx
    3dbb:	5d                   	pop    %ebp
    3dbc:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
    3dc3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3dca:	8d 45 0c             	lea    0xc(%ebp),%eax
    3dcd:	83 c0 04             	add    $0x4,%eax
    3dd0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(i = 0; fmt[i]; i++){
    3dd3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    3dda:	e9 7e 01 00 00       	jmp    3f5d <printf+0x1a0>
    c = fmt[i] & 0xff;
    3ddf:	8b 55 0c             	mov    0xc(%ebp),%edx
    3de2:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3de5:	8d 04 02             	lea    (%edx,%eax,1),%eax
    3de8:	0f b6 00             	movzbl (%eax),%eax
    3deb:	0f be c0             	movsbl %al,%eax
    3dee:	25 ff 00 00 00       	and    $0xff,%eax
    3df3:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(state == 0){
    3df6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3dfa:	75 2c                	jne    3e28 <printf+0x6b>
      if(c == '%'){
    3dfc:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    3e00:	75 0c                	jne    3e0e <printf+0x51>
        state = '%';
    3e02:	c7 45 f0 25 00 00 00 	movl   $0x25,-0x10(%ebp)
    3e09:	e9 4b 01 00 00       	jmp    3f59 <printf+0x19c>
      } else {
        putc(fd, c);
    3e0e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e11:	0f be c0             	movsbl %al,%eax
    3e14:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e18:	8b 45 08             	mov    0x8(%ebp),%eax
    3e1b:	89 04 24             	mov    %eax,(%esp)
    3e1e:	e8 c1 fe ff ff       	call   3ce4 <putc>
    3e23:	e9 31 01 00 00       	jmp    3f59 <printf+0x19c>
      }
    } else if(state == '%'){
    3e28:	83 7d f0 25          	cmpl   $0x25,-0x10(%ebp)
    3e2c:	0f 85 27 01 00 00    	jne    3f59 <printf+0x19c>
      if(c == 'd'){
    3e32:	83 7d e8 64          	cmpl   $0x64,-0x18(%ebp)
    3e36:	75 2d                	jne    3e65 <printf+0xa8>
        printint(fd, *ap, 10, 1);
    3e38:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e3b:	8b 00                	mov    (%eax),%eax
    3e3d:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e44:	00 
    3e45:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e4c:	00 
    3e4d:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e51:	8b 45 08             	mov    0x8(%ebp),%eax
    3e54:	89 04 24             	mov    %eax,(%esp)
    3e57:	e8 b0 fe ff ff       	call   3d0c <printint>
        ap++;
    3e5c:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3e60:	e9 ed 00 00 00       	jmp    3f52 <printf+0x195>
      } else if(c == 'x' || c == 'p'){
    3e65:	83 7d e8 78          	cmpl   $0x78,-0x18(%ebp)
    3e69:	74 06                	je     3e71 <printf+0xb4>
    3e6b:	83 7d e8 70          	cmpl   $0x70,-0x18(%ebp)
    3e6f:	75 2d                	jne    3e9e <printf+0xe1>
        printint(fd, *ap, 16, 0);
    3e71:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e74:	8b 00                	mov    (%eax),%eax
    3e76:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e7d:	00 
    3e7e:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e85:	00 
    3e86:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e8a:	8b 45 08             	mov    0x8(%ebp),%eax
    3e8d:	89 04 24             	mov    %eax,(%esp)
    3e90:	e8 77 fe ff ff       	call   3d0c <printint>
        ap++;
    3e95:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
      }
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
    ...
    3e99:	e9 b4 00 00 00       	jmp    3f52 <printf+0x195>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3e9e:	83 7d e8 73          	cmpl   $0x73,-0x18(%ebp)
    3ea2:	75 46                	jne    3eea <printf+0x12d>
        s = (char*)*ap;
    3ea4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ea7:	8b 00                	mov    (%eax),%eax
    3ea9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        ap++;
    3eac:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
        if(s == 0)
    3eb0:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    3eb4:	75 27                	jne    3edd <printf+0x120>
          s = "(null)";
    3eb6:	c7 45 e4 82 5b 00 00 	movl   $0x5b82,-0x1c(%ebp)
        while(*s != 0){
    3ebd:	eb 1f                	jmp    3ede <printf+0x121>
          putc(fd, *s);
    3ebf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    ...
    3ed2:	e8 0d fe ff ff       	call   3ce4 <putc>
          s++;
    3ed7:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    3edb:	eb 01                	jmp    3ede <printf+0x121>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3ee1:	0f b6 00             	movzbl (%eax),%eax
    3ee4:	84 c0                	test   %al,%al
    3ee6:	75 d7                	jne    3ebf <printf+0x102>
    3ee8:	eb 68                	jmp    3f52 <printf+0x195>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3eea:	83 7d e8 63          	cmpl   $0x63,-0x18(%ebp)
    3eee:	75 1d                	jne    3f0d <printf+0x150>
        putc(fd, *ap);
    3ef0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ef3:	8b 00                	mov    (%eax),%eax
    3ef5:	0f be c0             	movsbl %al,%eax
    3ef8:	89 44 24 04          	mov    %eax,0x4(%esp)
    3efc:	8b 45 08             	mov    0x8(%ebp),%eax
    3eff:	89 04 24             	mov    %eax,(%esp)
    3f02:	e8 dd fd ff ff       	call   3ce4 <putc>
        ap++;
    3f07:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3f0b:	eb 45                	jmp    3f52 <printf+0x195>
      } else if(c == '%'){
    3f0d:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    3f11:	75 17                	jne    3f2a <printf+0x16d>
        putc(fd, c);
    3f13:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f16:	0f be c0             	movsbl %al,%eax
    3f19:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f1d:	8b 45 08             	mov    0x8(%ebp),%eax
    3f20:	89 04 24             	mov    %eax,(%esp)
    3f23:	e8 bc fd ff ff       	call   3ce4 <putc>
    3f28:	eb 28                	jmp    3f52 <printf+0x195>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f2a:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f31:	00 
    3f32:	8b 45 08             	mov    0x8(%ebp),%eax
    3f35:	89 04 24             	mov    %eax,(%esp)
    3f38:	e8 a7 fd ff ff       	call   3ce4 <putc>
        putc(fd, c);
    3f3d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f40:	0f be c0             	movsbl %al,%eax
    3f43:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f47:	8b 45 08             	mov    0x8(%ebp),%eax
    3f4a:	89 04 24             	mov    %eax,(%esp)
    3f4d:	e8 92 fd ff ff       	call   3ce4 <putc>
      }
      state = 0;
    3f52:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f59:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    3f5d:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f60:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3f63:	8d 04 02             	lea    (%edx,%eax,1),%eax
    3f66:	0f b6 00             	movzbl (%eax),%eax
    3f69:	84 c0                	test   %al,%al
    3f6b:	0f 85 6e fe ff ff    	jne    3ddf <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f83:	a1 88 5c 00 00       	mov    0x5c88,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    4044:	a3 88 5c 00 00       	mov    %eax,0x5c88
}
    4049:	c9                   	leave  
    404a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    406a:	e8 35 fc ff ff       	call   3ca4 <sbrk>
    406f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(p == (char*)-1)
    4072:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
  ...
  return freep;
    409c:	a1 88 5c 00 00       	mov    0x5c88,%eax
}
    40a1:	c9                   	leave  
    40a2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40b8:	a1 88 5c 00 00       	mov    0x5c88,%eax
    40bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40c0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40c4:	75 23                	jne    40e9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40c6:	c7 45 f0 80 5c 00 00 	movl   $0x5c80,-0x10(%ebp)
    40cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d0:	a3 88 5c 00 00       	mov    %eax,0x5c88
    40d5:	a1 88 5c 00 00       	mov    0x5c88,%eax
    40da:	a3 80 5c 00 00       	mov    %eax,0x5c80
    base.s.size = 0;
    40df:	c7 05 84 5c 00 00 00 	movl   $0x0,0x5c84
    40e6:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    415e:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4161:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    416e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4171:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4174:	8b 45 ec             	mov    -0x14(%ebp),%eax
...
xchg(volatile uint *addr, uint newval)
{
    ...
    4187:	83 ec 10             	sub    $0x10,%esp
  uint result;
  
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
    418a:	8b 55 08             	mov    0x8(%ebp),%edx
    418d:	8b 45 0c             	mov    0xc(%ebp),%eax
    4190:	8b 4d 08             	mov    0x8(%ebp),%ecx
    4193:	f0 87 02             	lock xchg %eax,(%edx)
    4196:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
    4199:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
    419c:	c9                   	leave  
    419d:	c3                   	ret    
...
void lock_init(lock_t *lock){
    419e:	55                   	push   %ebp
    419f:	89 e5                	mov    %esp,%ebp
    lock->locked = 0;
    41a1:	8b 45 08             	mov    0x8(%ebp),%eax
    41a4:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    41aa:	5d                   	pop    %ebp
    41ab:	c3                   	ret    

000041ac <lock_acquire>:
void lock_acquire(lock_t *lock){
    41ac:	55                   	push   %ebp
    41ad:	89 e5                	mov    %esp,%ebp
    41af:	83 ec 08             	sub    $0x8,%esp
    while(xchg(&lock->locked,1) != 0);
    41b2:	8b 45 08             	mov    0x8(%ebp),%eax
    41b5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    41bc:	00 
    41bd:	89 04 24             	mov    %eax,(%esp)
    41c0:	e8 bf ff ff ff       	call   4184 <xchg>
    41c5:	85 c0                	test   %eax,%eax
    41c7:	75 e9                	jne    41b2 <lock_acquire+0x6>
}
    41c9:	c9                   	leave  
    41ca:	c3                   	ret    

000041cb <lock_release>:
void lock_release(lock_t *lock){
    ...
    41d4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    41db:	00 
    41dc:	89 04 24             	mov    %eax,(%esp)
    41df:	e8 a0 ff ff ff       	call   4184 <xchg>
}
    41e4:	c9                   	leave  
    41e5:	c3                   	ret    

000041e6 <thread_create>:

void *thread_create(void(*start_routine)(void*), void *arg){
    41e6:	55                   	push   %ebp
    41e7:	89 e5                	mov    %esp,%ebp
    41e9:	83 ec 28             	sub    $0x28,%esp
    int tid;
    void * stack = malloc(2 * 4096);
    41ec:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    41f3:	e8 ab fe ff ff       	call   40a3 <malloc>
    41f8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    void *garbage_stack = stack; 
    41fb:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
   // printf(1,"start routine addr : %d\n",(uint)start_routine);


    if((uint)stack % 4096){
    4201:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4204:	25 ff 0f 00 00       	and    $0xfff,%eax
    4209:	85 c0                	test   %eax,%eax
    420b:	74 15                	je     4222 <thread_create+0x3c>
        stack = stack + (4096 - (uint)stack % 4096);
    420d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4210:	89 c2                	mov    %eax,%edx
    4212:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    4218:	b8 00 10 00 00       	mov    $0x1000,%eax
    421d:	29 d0                	sub    %edx,%eax
    421f:	01 45 f0             	add    %eax,-0x10(%ebp)
    }
    if (stack == 0){
    4222:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4226:	75 1b                	jne    4243 <thread_create+0x5d>

        printf(1,"malloc fail \n");
    4228:	c7 44 24 04 89 5b 00 	movl   $0x5b89,0x4(%esp)
    422f:	00 
    4230:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4237:	e8 81 fb ff ff       	call   3dbd <printf>
        return 0;
    423c:	b8 00 00 00 00       	mov    $0x0,%eax
    4241:	eb 6f                	jmp    42b2 <thread_create+0xcc>
    }

    tid = clone((uint)stack,PSIZE,(uint)start_routine,(int)arg);
    4243:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    4246:	8b 55 08             	mov    0x8(%ebp),%edx
    4249:	8b 45 f0             	mov    -0x10(%ebp),%eax
    424c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
    4250:	89 54 24 08          	mov    %edx,0x8(%esp)
    4254:	c7 44 24 04 00 10 00 	movl   $0x1000,0x4(%esp)
    425b:	00 
    425c:	89 04 24             	mov    %eax,(%esp)
    425f:	e8 58 fa ff ff       	call   3cbc <clone>
    4264:	89 45 ec             	mov    %eax,-0x14(%ebp)
    if(tid < 0){
    4267:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    426b:	79 1b                	jns    4288 <thread_create+0xa2>
        printf(1,"clone fails\n");
    426d:	c7 44 24 04 97 5b 00 	movl   $0x5b97,0x4(%esp)
    4274:	00 
    4275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    427c:	e8 3c fb ff ff       	call   3dbd <printf>
        return 0;
    4281:	b8 00 00 00 00       	mov    $0x0,%eax
    4286:	eb 2a                	jmp    42b2 <thread_create+0xcc>
    }
    if(tid > 0){
    4288:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    428c:	7e 05                	jle    4293 <thread_create+0xad>
        //store threads on thread table
        return garbage_stack;
    428e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4291:	eb 1f                	jmp    42b2 <thread_create+0xcc>
    }
    if(tid == 0){
    4293:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4297:	75 14                	jne    42ad <thread_create+0xc7>
        printf(1,"tid = 0 return \n");
    4299:	c7 44 24 04 a4 5b 00 	movl   $0x5ba4,0x4(%esp)
    42a0:	00 
    42a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    42a8:	e8 10 fb ff ff       	call   3dbd <printf>
    }
//    wait();
//    free(garbage_stack);
...
void init_q(struct queue *q){
    ...
    42cd:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    42d4:	5d                   	pop    %ebp
    42d5:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    42d9:	83 ec 28             	sub    $0x28,%esp
    //printf(1, "here \n");
		struct node * n = malloc(sizeof(struct node));
    42dc:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    42e3:	e8 bb fd ff ff       	call   40a3 <malloc>
    42e8:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    42eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42ee:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    42f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42f8:	8b 55 0c             	mov    0xc(%ebp),%edx
    42fb:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    42fd:	8b 45 08             	mov    0x8(%ebp),%eax
    4300:	8b 40 04             	mov    0x4(%eax),%eax
    4303:	85 c0                	test   %eax,%eax
    4305:	75 0b                	jne    4312 <add_q+0x3c>
        q->head = n;
    4307:	8b 45 08             	mov    0x8(%ebp),%eax
    430a:	8b 55 f4             	mov    -0xc(%ebp),%edx
    430d:	89 50 04             	mov    %edx,0x4(%eax)
    4310:	eb 0c                	jmp    431e <add_q+0x48>
    }else{
        q->tail->next = n;
    4312:	8b 45 08             	mov    0x8(%ebp),%eax
    4315:	8b 40 08             	mov    0x8(%eax),%eax
    4318:	8b 55 f4             	mov    -0xc(%ebp),%edx
    431b:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    431e:	8b 45 08             	mov    0x8(%ebp),%eax
    4321:	8b 55 f4             	mov    -0xc(%ebp),%edx
    4324:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    4327:	8b 45 08             	mov    0x8(%ebp),%eax
    432a:	8b 00                	mov    (%eax),%eax
    432c:	8d 50 01             	lea    0x1(%eax),%edx
    432f:	8b 45 08             	mov    0x8(%ebp),%eax
    4332:	89 10                	mov    %edx,(%eax)
}
    4334:	c9                   	leave  
    4335:	c3                   	ret    
...
int empty_q(struct queue *q){
    ...
    433e:	85 c0                	test   %eax,%eax
    4340:	75 07                	jne    4349 <empty_q+0x13>
        return 1;
    4342:	b8 01 00 00 00       	mov    $0x1,%eax
    4347:	eb 05                	jmp    434e <empty_q+0x18>
    else
        return 0;
    4349:	b8 00 00 00 00       	mov    $0x0,%eax
} 
    434e:	5d                   	pop    %ebp
    434f:	c3                   	ret    
...
int pop_q(struct queue *q){
    ...
    4353:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    4356:	8b 45 08             	mov    0x8(%ebp),%eax
    4359:	89 04 24             	mov    %eax,(%esp)
    435c:	e8 d5 ff ff ff       	call   4336 <empty_q>
    4361:	85 c0                	test   %eax,%eax
    4363:	75 5d                	jne    43c2 <pop_q+0x72>
       val = q->head->value; 
    4365:	8b 45 08             	mov    0x8(%ebp),%eax
    4368:	8b 40 04             	mov    0x4(%eax),%eax
    436b:	8b 00                	mov    (%eax),%eax
    436d:	89 45 f0             	mov    %eax,-0x10(%ebp)
       destroy = q->head;
    ...
    437f:	8b 50 04             	mov    0x4(%eax),%edx
    4382:	8b 45 08             	mov    0x8(%ebp),%eax
    4385:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    4388:	8b 45 f4             	mov    -0xc(%ebp),%eax
    438b:	89 04 24             	mov    %eax,(%esp)
    438e:	e8 e1 fb ff ff       	call   3f74 <free>
       q->size--;
    4393:	8b 45 08             	mov    0x8(%ebp),%eax
    4396:	8b 00                	mov    (%eax),%eax
    4398:	8d 50 ff             	lea    -0x1(%eax),%edx
    439b:	8b 45 08             	mov    0x8(%ebp),%eax
    439e:	89 10                	mov    %edx,(%eax)
       if(q->size == 0){
    43a0:	8b 45 08             	mov    0x8(%ebp),%eax
    43a3:	8b 00                	mov    (%eax),%eax
    43a5:	85 c0                	test   %eax,%eax
    43a7:	75 14                	jne    43bd <pop_q+0x6d>
            q->head = 0;
    43a9:	8b 45 08             	mov    0x8(%ebp),%eax
    43ac:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    43b3:	8b 45 08             	mov    0x8(%ebp),%eax
    43b6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    43bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43c0:	eb 05                	jmp    43c7 <pop_q+0x77>
    }
    return -1;
    43c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    43c7:	c9                   	leave  
    43c8:	c3                   	ret    
    43c9:	90                   	nop
...
void init_semaphore(struct Semaphore *s, int count_num) {
    43cc:	55                   	push   %ebp
    43cd:	89 e5                	mov    %esp,%ebp
    43cf:	83 ec 18             	sub    $0x18,%esp
	s->count = count_num;
    43d2:	8b 45 08             	mov    0x8(%ebp),%eax
    43d5:	8b 55 0c             	mov    0xc(%ebp),%edx
    43d8:	89 10                	mov    %edx,(%eax)
	init_q(&s->threads);
    43da:	8b 45 08             	mov    0x8(%ebp),%eax
    43dd:	83 c0 04             	add    $0x4,%eax
    43e0:	89 04 24             	mov    %eax,(%esp)
    43e3:	e8 cc fe ff ff       	call   42b4 <init_q>
	lock_init(&s->lock);
    43e8:	8b 45 08             	mov    0x8(%ebp),%eax
    43eb:	83 c0 10             	add    $0x10,%eax
    43ee:	89 04 24             	mov    %eax,(%esp)
    43f1:	e8 a8 fd ff ff       	call   419e <lock_init>
}
    43f6:	c9                   	leave  
    43f7:	c3                   	ret    

000043f8 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
    ...
    4433:	c7 44 24 04 b5 5b 00 	movl   $0x5bb5,0x4(%esp)
    443a:	00 
    443b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4442:	e8 76 f9 ff ff       	call   3dbd <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
    4447:	e8 50 f8 ff ff       	call   3c9c <getpid>
    444c:	8b 55 08             	mov    0x8(%ebp),%edx
    444f:	83 c2 04             	add    $0x4,%edx
    4452:	89 44 24 04          	mov    %eax,0x4(%esp)
    4456:	89 14 24             	mov    %edx,(%esp)
    4459:	e8 78 fe ff ff       	call   42d6 <add_q>
			//printf(1, "asleep \n");
			tsleep();
    445e:	e8 69 f8 ff ff       	call   3ccc <tsleep>
		}
	}
    4463:	eb 99                	jmp    43fe <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
    4465:	55                   	push   %ebp
    4466:	89 e5                	mov    %esp,%ebp
    4468:	83 ec 18             	sub    $0x18,%esp
	lock_acquire(&s->lock);
    446b:	8b 45 08             	mov    0x8(%ebp),%eax
    446e:	83 c0 10             	add    $0x10,%eax
    4471:	89 04 24             	mov    %eax,(%esp)
    4474:	e8 33 fd ff ff       	call   41ac <lock_acquire>
	s->count++;
    4479:	8b 45 08             	mov    0x8(%ebp),%eax
    447c:	8b 00                	mov    (%eax),%eax
    447e:	8d 50 01             	lea    0x1(%eax),%edx
    4481:	8b 45 08             	mov    0x8(%ebp),%eax
    4484:	89 10                	mov    %edx,(%eax)
	lock_release(&s->lock);
    4486:	8b 45 08             	mov    0x8(%ebp),%eax
    4489:	83 c0 10             	add    $0x10,%eax
    448c:	89 04 24             	mov    %eax,(%esp)
    448f:	e8 37 fd ff ff       	call   41cb <lock_release>
	if (!empty_q(&s->threads)) {
    4494:	8b 45 08             	mov    0x8(%ebp),%eax
    4497:	83 c0 04             	add    $0x4,%eax
    449a:	89 04 24             	mov    %eax,(%esp)
    449d:	e8 94 fe ff ff       	call   4336 <empty_q>
    44a2:	85 c0                	test   %eax,%eax
    44a4:	75 16                	jne    44bc <sem_signal+0x57>
		twakeup(pop_q(&s->threads));							//remove thread from queue and wake up
    44a6:	8b 45 08             	mov    0x8(%ebp),%eax
    44a9:	83 c0 04             	add    $0x4,%eax
    44ac:	89 04 24             	mov    %eax,(%esp)
    44af:	e8 9c fe ff ff       	call   4350 <pop_q>
    44b4:	89 04 24             	mov    %eax,(%esp)
    44b7:	e8 18 f8 ff ff       	call   3cd4 <twakeup>
	}
}
    44bc:	c9                   	leave  
    44bd:	c3                   	ret    
