...
//    void * sp;
  ...
  1b:	c7 44 24 04 70 0f 00 	movl   $0xf70,0x4(%esp)
  22:	00 
  ...
  44:	a3 c0 10 00 00       	mov    %eax,0x10c0
    numpass = atoi(argv[2]);
  ...
  59:	a3 c4 10 00 00       	mov    %eax,0x10c4

    void * slist[numthreads];
  5e:	8b 0d c0 10 00 00    	mov    0x10c0,%ecx
  ...
  f9:	c7 04 24 e0 10 00 00 	movl   $0x10e0,(%esp)
 100:	e8 49 0b 00 00       	call   c4e <lock_init>
    ttable.total = 0;
 105:	c7 05 e4 12 00 00 00 	movl   $0x0,0x12e4
 10c:	00 00 00 
    for(t=ttable.thread;t < &ttable.thread[64];t++){
 10f:	c7 45 dc e4 10 00 00 	movl   $0x10e4,-0x24(%ebp)
 ...
 125:	b8 e4 12 00 00       	mov    $0x12e4,%eax
 ...
 14f:	c7 04 24 e8 12 00 00 	movl   $0x12e8,(%esp)
 156:	e8 f3 0a 00 00       	call   c4e <lock_init>
    frisbee.pass = 0;
 15b:	c7 05 ec 12 00 00 00 	movl   $0x0,0x12ec
 162:	00 00 00 
    frisbee.holding_thread = 0;
 165:	c7 05 f0 12 00 00 00 	movl   $0x0,0x12f0
 16c:	00 00 00 

    printf(1,"\nnum of threads %d \n",numthreads);
 16f:	a1 c0 10 00 00       	mov    0x10c0,%eax
 174:	89 44 24 08          	mov    %eax,0x8(%esp)
 178:	c7 44 24 04 85 0f 00 	movl   $0xf85,0x4(%esp)
 17f:	00 
 180:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 187:	e8 e1 06 00 00       	call   86d <printf>
    printf(1,"num of passes %d \n\n",numpass);
 18c:	a1 c4 10 00 00       	mov    0x10c4,%eax
 191:	89 44 24 08          	mov    %eax,0x8(%esp)
 195:	c7 44 24 04 9a 0f 00 	movl   $0xf9a,0x4(%esp)
 19c:	00 
 ...
 1cf:	c7 44 24 04 ae 0f 00 	movl   $0xfae,0x4(%esp)
 1d6:	00 
 ...
 1f5:	a1 c0 10 00 00       	mov    0x10c0,%eax
...
//    sleep(5);
 ...
 216:	a1 c0 10 00 00       	mov    0x10c0,%eax
 ...
 222:	90                   	nop
   ...
   // add printf for tid look up.  
    for(t=ttable.thread;t < &ttable.thread[64];t++){
 223:	c7 45 dc e4 10 00 00 	movl   $0x10e4,-0x24(%ebp)
 ...
 23e:	c7 44 24 04 c4 0f 00 	movl   $0xfc4,0x4(%esp)
 245:	00 
 ...
 256:	b8 e4 12 00 00       	mov    $0x12e4,%eax
 ...
 291:	a1 c0 10 00 00       	mov    0x10c0,%eax
...
void pass_next(void *arg){
 ...
 2ae:	c7 04 24 e0 10 00 00 	movl   $0x10e0,(%esp)
 2b5:	e8 a2 09 00 00       	call   c5c <lock_acquire>
    for(t=ttable.thread;t < &ttable.thread[64];t++){
 2ba:	c7 45 f0 e4 10 00 00 	movl   $0x10e4,-0x10(%ebp)
 ...
 2da:	b8 e4 12 00 00       	mov    $0x12e4,%eax
 ...
 2e2:	72 df                	jb     2c3 <pass_next+0x23>
    ...
    ttable.total++;
 2e4:	a1 e4 12 00 00       	mov    0x12e4,%eax
 2e9:	83 c0 01             	add    $0x1,%eax
 2ec:	a3 e4 12 00 00       	mov    %eax,0x12e4
    lock_release(&ttable.lock);
 2f1:	c7 04 24 e0 10 00 00 	movl   $0x10e0,(%esp)
 2f8:	e8 7e 09 00 00       	call   c7b <lock_release>

   for(;;){
        lock_acquire(&ttable.lock);
 2fd:	c7 04 24 e0 10 00 00 	movl   $0x10e0,(%esp)
 304:	e8 53 09 00 00       	call   c5c <lock_acquire>
        if(ttable.total == numthreads){
 309:	8b 15 e4 12 00 00    	mov    0x12e4,%edx
 30f:	a1 c0 10 00 00       	mov    0x10c0,%eax
 ...
 321:	c7 44 24 04 ec 0f 00 	movl   $0xfec,0x4(%esp)
 328:	00 
 329:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 330:	e8 38 05 00 00       	call   86d <printf>
            barrier++;
 335:	a1 c8 10 00 00       	mov    0x10c8,%eax
 33a:	83 c0 01             	add    $0x1,%eax
 33d:	a3 c8 10 00 00       	mov    %eax,0x10c8
            goto start;
 342:	90                   	nop
        lock_release(&ttable.lock);
    }
...
start:
     lock_release(&ttable.lock);
 343:	c7 04 24 e0 10 00 00 	movl   $0x10e0,(%esp)
 ...
 34f:	eb 0e                	jmp    35f <pass_next+0xbf>
        ...
        lock_release(&ttable.lock);
 351:	c7 04 24 e0 10 00 00 	movl   $0x10e0,(%esp)
...
leaving: 
    lock_release(&frisbee.lock);
 396:	c7 04 24 e8 12 00 00 	movl   $0x12e8,(%esp)
 ...
 3a9:	c7 44 24 04 38 10 00 	movl   $0x1038,0x4(%esp)
 3b0:	00 
 ...
 3c2:	a1 f0 12 00 00       	mov    0x12f0,%eax
 3c7:	3b 45 f4             	cmp    -0xc(%ebp),%eax
 3ca:	75 1b                	jne    3e7 <pass_next+0x147>
            lock_release(&frisbee.lock);
 3cc:	c7 04 24 e8 12 00 00 	movl   $0x12e8,(%esp)
 ...
 3e5:	eb 87                	jmp    36e <pass_next+0xce>
        ...
        printf(1,"pass: %d, thread %d catch the frisbee. throwing...\n",
 3e7:	a1 ec 12 00 00       	mov    0x12ec,%eax
 3ec:	8b 55 f4             	mov    -0xc(%ebp),%edx
 3ef:	89 54 24 0c          	mov    %edx,0xc(%esp)
 3f3:	89 44 24 08          	mov    %eax,0x8(%esp)
 3f7:	c7 44 24 04 04 10 00 	movl   $0x1004,0x4(%esp)
 3fe:	00 
 3ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 406:	e8 62 04 00 00       	call   86d <printf>
                frisbee.pass, tid);
        frisbee.pass++;
 40b:	a1 ec 12 00 00       	mov    0x12ec,%eax
 410:	83 c0 01             	add    $0x1,%eax
 413:	a3 ec 12 00 00       	mov    %eax,0x12ec
        frisbee.holding_thread = tid;
 418:	8b 45 f4             	mov    -0xc(%ebp),%eax
 41b:	a3 f0 12 00 00       	mov    %eax,0x12f0
        lock_release(&frisbee.lock);
 420:	c7 04 24 e8 12 00 00 	movl   $0x12e8,(%esp)
...
int lookup(int num_threads){
 ...
 437:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
    for(t=ttable.thread;t<&ttable.thread[64];t++){
 43e:	c7 45 fc e4 10 00 00 	movl   $0x10e4,-0x4(%ebp)
...
int lookup(int num_threads){
 ...
 458:	b8 e4 12 00 00       	mov    $0x12e4,%eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 806:	0f b6 80 9c 10 00 00 	movzbl 0x109c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 964:	75 27                	jne    98d <printf+0x120>
          s = "(null)";
 966:	c7 45 e4 4f 10 00 00 	movl   $0x104f,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 a33:	a1 d4 10 00 00       	mov    0x10d4,%eax
...
free(void *ap)
{
 ...
 af4:	a3 d4 10 00 00       	mov    %eax,0x10d4
}
 af9:	c9                   	leave  
 afa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 b47:	e8 d8 fe ff ff       	call   a24 <free>
  return freep;
 b4c:	a1 d4 10 00 00       	mov    0x10d4,%eax
}
 b51:	c9                   	leave  
 b52:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 b65:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 b68:	a1 d4 10 00 00       	mov    0x10d4,%eax
 b6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 b70:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 b74:	75 23                	jne    b99 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 b76:	c7 45 f0 cc 10 00 00 	movl   $0x10cc,-0x10(%ebp)
 b7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b80:	a3 d4 10 00 00       	mov    %eax,0x10d4
 b85:	a1 d4 10 00 00       	mov    0x10d4,%eax
 b8a:	a3 cc 10 00 00       	mov    %eax,0x10cc
    base.s.size = 0;
 b8f:	c7 05 d0 10 00 00 00 	movl   $0x0,0x10d0
 b96:	00 00 00 
  }
 ...
 bec:	a3 d4 10 00 00       	mov    %eax,0x10d4
      return (void*)(p + 1);
 ...
 bf7:	eb 38                	jmp    c31 <malloc+0xde>
    ...
    if(p == freep)
 bf9:	a1 d4 10 00 00       	mov    0x10d4,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 cd8:	c7 44 24 04 56 10 00 	movl   $0x1056,0x4(%esp)
 cdf:	00 
 ...
 d1d:	c7 44 24 04 64 10 00 	movl   $0x1064,0x4(%esp)
 d24:	00 
 ...
 d49:	c7 44 24 04 71 10 00 	movl   $0x1071,0x4(%esp)
 d50:	00 
...
void init_semaphore(struct Semaphore *s, int count_num) {
 ...
 e8d:	83 c0 04             	add    $0x4,%eax
 e90:	89 04 24             	mov    %eax,(%esp)
 e93:	e8 cc fe ff ff       	call   d64 <init_q>
	lock_init(&s->lock);
 e98:	8b 45 08             	mov    0x8(%ebp),%eax
 e9b:	83 c0 10             	add    $0x10,%eax
 e9e:	89 04 24             	mov    %eax,(%esp)
 ea1:	e8 a8 fd ff ff       	call   c4e <lock_init>
}
 ea6:	c9                   	leave  
 ea7:	c3                   	ret    

00000ea8 <sem_acquire>:
...
void sem_acquire(struct Semaphore *s) {
 ...
 ed5:	83 c0 10             	add    $0x10,%eax
 ed8:	89 04 24             	mov    %eax,(%esp)
 edb:	e8 9b fd ff ff       	call   c7b <lock_release>
			break;
 ee0:	90                   	nop
 ...
 ee3:	c7 44 24 04 82 10 00 	movl   $0x1082,0x4(%esp)
 eea:	00 
 eeb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 ef2:	e8 76 f9 ff ff       	call   86d <printf>
			//printf(1, "%d", getpid());
			add_q(&s->threads, getpid());						//add thread to sleep queueu
 ef7:	e8 50 f8 ff ff       	call   74c <getpid>
 efc:	8b 55 08             	mov    0x8(%ebp),%edx
 eff:	83 c2 04             	add    $0x4,%edx
 f02:	89 44 24 04          	mov    %eax,0x4(%esp)
 f06:	89 14 24             	mov    %edx,(%esp)
 f09:	e8 78 fe ff ff       	call   d86 <add_q>
			//printf(1, "asleep \n");
			tsleep();
 f0e:	e8 69 f8 ff ff       	call   77c <tsleep>
		}
	}
 f13:	eb 99                	jmp    eae <sem_acquire+0x6>
...
void sem_signal(struct Semaphore *s) {
 ...
 f1e:	83 c0 10             	add    $0x10,%eax
 f21:	89 04 24             	mov    %eax,(%esp)
 f24:	e8 33 fd ff ff       	call   c5c <lock_acquire>
	s->count++;
 f29:	8b 45 08             	mov    0x8(%ebp),%eax
 f2c:	8b 00                	mov    (%eax),%eax
 f2e:	8d 50 01             	lea    0x1(%eax),%edx
 f31:	8b 45 08             	mov    0x8(%ebp),%eax
 f34:	89 10                	mov    %edx,(%eax)
	lock_release(&s->lock);
 f36:	8b 45 08             	mov    0x8(%ebp),%eax
 f39:	83 c0 10             	add    $0x10,%eax
 f3c:	89 04 24             	mov    %eax,(%esp)
 f3f:	e8 37 fd ff ff       	call   c7b <lock_release>
	if (!empty_q(&s->threads)) {
 f44:	8b 45 08             	mov    0x8(%ebp),%eax
 f47:	83 c0 04             	add    $0x4,%eax
 f4a:	89 04 24             	mov    %eax,(%esp)
 f4d:	e8 94 fe ff ff       	call   de6 <empty_q>
 f52:	85 c0                	test   %eax,%eax
 f54:	75 16                	jne    f6c <sem_signal+0x57>
		twakeup(pop_q(&s->threads));							//remove thread from queue and wake up
 f56:	8b 45 08             	mov    0x8(%ebp),%eax
 f59:	83 c0 04             	add    $0x4,%eax
 f5c:	89 04 24             	mov    %eax,(%esp)
 f5f:	e8 9c fe ff ff       	call   e00 <pop_q>
 f64:	89 04 24             	mov    %eax,(%esp)
 f67:	e8 18 f8 ff ff       	call   784 <twakeup>
	}
}
 f6c:	c9                   	leave  
 f6d:	c3                   	ret    
